...
public class AlphabeticStatisticColumn<T extends Comparable<T>> extends StatisticColumn<T> {
    ...
    public AlphabeticStatisticColumn( String schema, String table, String column, SqlTypeName type ) {
        super( schema, table, column, type );
    }


    public AlphabeticStatisticColumn( String[] splitColumn, SqlTypeName type ) {
