...
public class StatisticQueryColumn extends QueryColumn {
     ...
     */
    public StatisticQueryColumn( String schemaTableName, final SqlTypeName type, final String[] data ) {
        super( schemaTableName, type );
        this.data = data;
    }


    public StatisticQueryColumn( String schema, String table, String name, final SqlTypeName type, final String[] data ) {
