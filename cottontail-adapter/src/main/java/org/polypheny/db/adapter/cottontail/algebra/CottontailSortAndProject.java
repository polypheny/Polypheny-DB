...
public class CottontailSortAndProject extends SortAndProject implements CottontailAlg {
     ...
     */
    public CottontailSortAndProject( AlgOptCluster cluster,
            AlgTraitSet traits,
            AlgNode child,
...
//            context.visitChild( 0, getInput() );
    ...
    @Override
    public SortAndProject copy( AlgTraitSet traitSet, AlgNode input, List<RexNode> projects, AlgCollation newCollation, RexNode offset, RexNode fetch ) {
