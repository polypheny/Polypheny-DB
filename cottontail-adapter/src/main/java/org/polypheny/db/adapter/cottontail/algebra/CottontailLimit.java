...
public class CottontailLimit extends Sort implements CottontailAlg {

    public CottontailLimit( AlgOptCluster cluster, AlgTraitSet traits, AlgNode child, AlgCollation collation, RexNode offset, RexNode fetch ) {
