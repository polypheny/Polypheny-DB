...
VALUES ( 0, 0, 'deptno', 1, 'INTEGER', NULL, NULL, FALSE, NULL ),
       ...
       ( 13, 2, 'MonthlyIncome', 7, 'INTEGER', NULL, NULL, FALSE, NULL),
       ( 14, 2, 'RelationshipSatisfaction', 8, 'VARCHAR', 20, NULL, FALSE, 2 ),
       ( 15, 2, 'TotalWorkingYears', 9, 'INTEGER', NULL, NULL, FALSE, NULL),
       ( 16, 2, 'YearsAtCompany', 10, 'INTEGER', NULL, NULL, FALSE, NULL),
       ( 17, 3, 'EmployeeNumber', 1, 'INTEGER', NULL, NULL, FALSE, NULL),
       ( 18, 3, 'EducationField', 2, 'VARCHAR', 20, NULL, FALSE, 2 ),
       ( 19, 3, 'JobInvolvement', 3, 'VARCHAR', 20, NULL, FALSE, 2 ),
       ( 20, 3, 'JobLevel', 4, 'INTEGER', NULL, NULL, FALSE, NULL),
       ( 21, 3, 'JobRole', 5, 'VARCHAR', 20, NULL, FALSE, 2 ),
       ( 22, 3, 'BusinessTravel', 6, 'VARCHAR', 20, NULL, FALSE, 2 ),
       ( 23, 3, 'Department', 7, 'VARCHAR', 20, NULL, FALSE, 2 ),
       ( 24, 3, 'Attrition', 8, 'VARCHAR', 20, NULL, FALSE, 2 ),
       ( 25, 3, 'DailyRate', 9, 'INTEGER', NULL, NULL, FALSE, NULL);
...
VALUES ( 1, 0, 0, 2, null, 'depts', 'deptno' ),
    ...
    ( 1, 7, 2, 2, null, 'emp', 'EmployeeNumber'),
    ( 1, 8, 2, 2, null, 'emp', 'Age'),
    ( 1, 9, 2, 2, null, 'emp', 'Gender'),
    ( 1, 10, 2, 2, null, 'emp', 'MaritalStatus'),
    ( 1, 11, 2, 2, null, 'emp', 'WorkLifeBalance'),
    ( 1, 12, 2, 2, null, 'emp', 'Education'),
    ( 1, 13, 2, 2, null, 'emp', 'MonthlyIncome'),
    ( 1, 14, 2, 2, null, 'emp', 'RelationshipSatisfaction' ),
    ( 1, 15, 2, 2, null, 'emp', 'TotalWorkingYears'),
    ( 1, 16, 2, 2, null, 'emp', 'YearsAtCompany'),
    ( 1, 17, 3, 2, null, 'work', 'EmployeeNumber'),
    ( 1, 18, 3, 2, null, 'work', 'EducationField'),
    ( 1, 19, 3, 2, null, 'work', 'JobInvolvement'),
    ( 1, 20, 3, 2, null, 'work', 'JobLevel'),
    ( 1, 21, 3, 2, null, 'work', 'JobRole'),
    ( 1, 22, 3, 2, null, 'work', 'BusinessTravel'),
    ( 1, 23, 3, 2, null, 'work', 'Department' ),
    ( 1, 24, 3, 2, null, 'work', 'Attrition' ),
    ( 1, 25, 3, 2, null, 'work', 'Department' );
