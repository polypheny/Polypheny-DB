...
VALUES ( 1, 0, 0, 2, null, 'depts', 'deptno' ),
    ...
    ( 1, 11, 3, 2, null, 'exploreEmployee', 'Age'),
    ( 1, 12, 3, 2, null, 'exploreEmployee', 'Attrition' ),
    ( 1, 13, 3, 2, null, 'exploreEmployee', 'BusinessTravel'),
    ( 1, 14, 3, 2, null, 'exploreEmployee', 'DailyRate'),
    ( 1, 15, 3, 2, null, 'exploreEmployee', 'Department' ),
    ( 1, 16, 3, 2, null, 'exploreEmployee', 'DistanceFromHome'),
    ( 1, 17, 3, 2, null, 'exploreEmployee', 'Education'),
    ( 1, 18, 3, 2, null, 'exploreEmployee', 'EducationField'),
    ( 1, 19, 3, 2, null, 'exploreEmployee', 'EmployeeCount'),
    ( 1, 20, 3, 2, null, 'exploreEmployee', 'EmployeeNumber'),
    ( 1, 21, 3, 2, null, 'exploreEmployee', 'EnvironmentSatisfaction'),
    ( 1, 22, 3, 2, null, 'exploreEmployee', 'Gender'),
    ( 1, 23, 3, 2, null, 'exploreEmployee', 'HourlyRate'),
    ( 1, 24, 3, 2, null, 'exploreEmployee', 'JobInvolvement'),
    ( 1, 25, 3, 2, null, 'exploreEmployee', 'JobLevel'),
    ( 1, 26, 3, 2, null, 'exploreEmployee', 'JobRole'),
    ( 1, 27, 3, 2, null, 'exploreEmployee', 'JobSatisfaction'),
    ( 1, 28, 3, 2, null, 'exploreEmployee', 'MaritalStatus'),
    ( 1, 29, 3, 2, null, 'exploreEmployee', 'MonthlyIncome'),
    ( 1, 30, 3, 2, null, 'exploreEmployee', 'MonthlyRate'),
    ( 1, 31, 3, 2, null, 'exploreEmployee', 'NumCompaniesWorked'),
    ( 1, 32, 3, 2, null, 'exploreEmployee', 'Over18' ),
    ( 1, 33, 3, 2, null, 'exploreEmployee', 'OverTime' ),
    ( 1, 34, 3, 2, null, 'exploreEmployee', 'PercentSalaryHike'),
    ( 1, 35, 3, 2, null, 'exploreEmployee', 'PerformanceRating'),
    ( 1, 36, 3, 2, null, 'exploreEmployee', 'RelationshipSatisfaction' ),
    ( 1, 37, 3, 2, null, 'exploreEmployee', 'StandardHours'),
    ( 1, 38, 3, 2, null, 'exploreEmployee', 'StockOptionLevel'),
    ( 1, 39, 3, 2, null, 'exploreEmployee', 'TotalWorkingYears'),
    ( 1, 40, 3, 2, null, 'exploreEmployee', 'TrainingTimesLastYear'),
    ( 1, 41, 3, 2, null, 'exploreEmployee', 'WorkLifeBalance'),
    ( 1, 42, 3, 2, null, 'exploreEmployee', 'YearsAtCompany'),
    ( 1, 43, 3, 2, null, 'exploreEmployee', 'YearsInCurrentRole'),
    ( 1, 44, 3, 2, null, 'exploreEmployee', 'YearsSinceLastPromotion'),
    ( 1, 45, 3, 2, null, 'exploreEmployee', 'YearsWithCurrManager');
