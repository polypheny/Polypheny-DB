...
public class ResourcePostRequest extends ResourceValuesRequest {
    ...
    public ResourcePostRequest( List<CatalogEntity> tables, List<RequestColumn> requestColumns, Map<String, RequestColumn> nameMapping, List<List<Pair<RequestColumn, Object>>> values, boolean useDynamicParams ) {
