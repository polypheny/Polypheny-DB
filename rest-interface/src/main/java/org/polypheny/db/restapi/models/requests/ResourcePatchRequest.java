...
public class ResourcePatchRequest extends ResourceValuesRequest {
    ...
    public ResourcePatchRequest( List<CatalogEntity> tables, List<RequestColumn> requestColumns, List<List<Pair<RequestColumn, Object>>> values, Map<String, RequestColumn> nameMapping, Filters filters, boolean useDynamicParams ) {
