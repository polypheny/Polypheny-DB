...
public class RequestParserOld {
    ...
    public RequestParserOld( final TransactionManager transactionManager, final Authenticator authenticator, final String userName, final String databaseName ) {
