...
//        polyphenyDbAssert()
//                .query( "select * from geode.BookMaster WHERE itemNumber > 122 AND itemNumber <= 123" )
//                .returnsCount( 1 )
//                .returns( "itemNumber=123; description=Run on sentences and drivel on all things mundane; "
//                        + "retailCost=34.99; yearPublished=2011; author=Daisy Mae West; title=A Treatise of "
//                        + "Treatises\n" )
...
//        String expectedQuery = "SELECT author AS author FROM /BookMaster WHERE itemNumber IN SET(123, 789)";
//
//        polyphenyDbAssert()
//                .query( "select author from geode.BookMaster WHERE itemNumber = 123 OR itemNumber = 789" )
//                .returnsCount( 2 )
...
//        polyphenyDbAssert()
//                .query( "SELECT author from geode.BookMaster WHERE (itemNumber > 123 AND itemNumber = 789) OR author='Daisy Mae West'" )
//                .returnsCount( 2 )
//                .returnsUnordered( "author=Jim Heavisides", "author=Daisy Mae West" )
//                .explainContains( "PLAN=GeodeToEnumerableConverter\n"
//                        + "  GeodeProject(author=[$4])\n"
...
//        polyphenyDbAssert()
//                .query( "SELECT author from geode.BookMaster WHERE (itemNumber > 100 OR itemNumber = 789) AND author='Daisy Mae West'" )
//                .returnsCount( 1 )
...
//        polyphenyDbAssert()
//                .query( "select yearPublished from geode.BookMaster ORDER BY yearPublished LIMIT 2" )
//                .returnsCount( 2 )
//                .returns( "yearPublished=1971\n"
//                        + "yearPublished=2011\n" )
//                .explainContains( "PLAN=GeodeToEnumerableConverter\n"
...
//        polyphenyDbAssert()
//                .query( "select yearPublished, itemNumber from geode.BookMaster ORDER BY yearPublished ASC, itemNumber DESC" )
//                .returnsCount( 3 )
//                .returns( "yearPublished=1971; itemNumber=456\n"
//                        + "yearPublished=2011; itemNumber=789\n"
//                        + "yearPublished=2011; itemNumber=123\n" )
//                .queryContains( GeodeAssertions.query( "SELECT yearPublished AS yearPublished, itemNumber AS itemNumber FROM /BookMaster ORDER BY yearPublished ASC, itemNumber DESC" ) );
//    }
//
//    //
...
//        polyphenyDbAssert()
//                .query( "select yearPublished from geode.BookMaster GROUP BY  yearPublished, author" )
//                .returnsCount( 3 )
//                .returns( "yearPublished=1971\n"
//                        + "yearPublished=2011\n"
//                        + "yearPublished=2011\n" )
...
//        polyphenyDbAssert()
//                .query( "select yearPublished, MAX(retailCost) from geode.BookMaster GROUP BY yearPublished" )
//                .returnsCount( 2 )
...
//        polyphenyDbAssert()
//                .query( "select yearPublished, COUNT(retailCost) from geode.BookMaster GROUP BY yearPublished" )
//                .returnsCount( 2 )
...
//        polyphenyDbAssert()
//                .query( "select MAX(retailCost), MIN(retailCost), SUM(retailCost), AVG(retailCost) from geode.BookMaster" )
//                .returnsCount( 1 )
//                .returns( "EXPR$0=59.99; EXPR$1=11.99; EXPR$2=106.97000122070312; EXPR$3=35.65666580200195\n" )
//                .explainContains( "PLAN=GeodeToEnumerableConverter\n"
...
//        polyphenyDbAssert()
//                .query( "select yearPublished, MAX(retailCost), MIN(retailCost), SUM(retailCost), AVG(retailCost) from geode.BookMaster GROUP BY  yearPublished" )
//                .returnsCount( 2 )
...
//        polyphenyDbAssert()
//                .query( "select yearPublished, MAX(retailCost) AS MAXCOST, author from geode.BookMaster GROUP BY yearPublished, author" )
//                .returnsCount( 3 )
...
//        polyphenyDbAssert()
//                .query( "select primaryAddress['addressLine2'] from geode.BookCustomer limit 2" )
//                .returnsCount( 2 )
//                .returns( "EXPR$0=null\n"
//                        + "EXPR$0=null\n" )
//                .explainContains( "PLAN=GeodeToEnumerableConverter\n"
...
//                .runs()
//                .queryContains( GeodeAssertions.query( "SELECT itemNumber AS itemNumber FROM /BookMaster WHERE itemNumber > 123" ) );
//    }
//
//
//    @Test
//    public void testSqlSingleNumberWhereFilter() {
//        polyphenyDbAssert().query( "SELECT * FROM geode.BookMaster WHERE itemNumber = 123" )
//                .runs()
//                .queryContains( GeodeAssertions.query( "SELECT * FROM /BookMaster WHERE itemNumber = 123" ) );
//    }
//
//
//    @Test
//    public void testSqlDistinctSort() {
//        polyphenyDbAssert().query( "SELECT DISTINCT itemNumber, author FROM geode.BookMaster ORDER BY itemNumber, author" ).runs();
//    }
//
//
//    @Test
//    public void testSqlDistinctSort2() {
//        polyphenyDbAssert().query( "SELECT itemNumber, author FROM geode.BookMaster GROUP BY itemNumber, author ORDER BY itemNumber, author" ).runs();
//    }
//
//
//    @Test
//    public void testSqlDistinctSort3() {
//        polyphenyDbAssert().query( "SELECT DISTINCT * FROM geode.BookMaster" ).runs();
//    }
//
//
//    @Test
//    public void testSqlLimit2() {
//        polyphenyDbAssert().query( "SELECT DISTINCT * FROM geode.BookMaster LIMIT 2" ).runs();
//    }
//
//
//    @Test
//    public void testSqlDisjunction() {
//        String expectedQuery = "SELECT author AS author FROM /BookMaster WHERE itemNumber IN SET(789, 123)";
//
//        polyphenyDbAssert()
//                .query( "SELECT author FROM geode.BookMaster WHERE itemNumber = 789 OR itemNumber = 123" )
//                .runs()
//                .queryContains( GeodeAssertions.query( expectedQuery ) );
//    }
//
...
//        polyphenyDbAssert().query( "SELECT author FROM geode.BookMaster WHERE itemNumber = 789 AND author = 'Jim Heavisides'" )
//                .runs()
//                .queryContains( GeodeAssertions.query( "SELECT author AS author FROM /BookMaster WHERE itemNumber = 789 AND author = 'Jim Heavisides'" ) );
//    }
//
//
//    @Test
//    public void testSqlBookMasterWhere() {
//        polyphenyDbAssert().query( "select author, title from geode.BookMaster WHERE author = 'Jim Heavisides' LIMIT 2" )
//                .runs()
//                .queryContains( GeodeAssertions.query( "SELECT author AS author, title AS title FROM /BookMaster WHERE author = 'Jim Heavisides' LIMIT 2" ) );
//    }
//
//
//    @Test
//    public void testSqlBookMasterCount() {
//        polyphenyDbAssert().query( "select count(*) from geode.BookMaster" ).runs();
//    }
//
//
//    @Test
//    public void testInSetFilterWithNestedStringField() {
//        String expectedQuery = "SELECT primaryAddress.city AS city FROM /BookCustomer WHERE primaryAddress.city IN SET('Topeka', 'San Francisco')";
//
//        polyphenyDbAssert()
