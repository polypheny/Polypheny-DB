...
public class TableIndex {
    ...
    public static TableIndex createIndex( String inDatabase, String schemaName, String tableName )
        ...
        try {
            ...
            log.error( "Cannot find a underlying table for the specified table name: "
                    + schemaName + "." + tableName + ".", e );
            throw new UnknownIndexException( "Cannot find a underlying table for the specified table name: "
