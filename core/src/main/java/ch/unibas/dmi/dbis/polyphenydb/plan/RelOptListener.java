...
public interface RelOptListener extends EventListener {
     ...
     * the rule is invoked, and once after. Note that the rel attribute of the event is always the old expression.
     *
     * @param event details about the event
     */
     ...
     * twice; once before registration of the new rel, and once after. Note that the rel attribute of the event is always the new expression; to get the
