 ...
 */
public class MqlParseException extends Exception implements PolyphenyDbParserException {

    private final MqlParserPos pos;
     ...
     */
    public MqlParseException( String message, MqlParserPos pos, int[][] expectedTokenSequences, String[] tokenImages, Throwable parserException ) {
