...
/**
 * SqlSingleOperandTypeChecker is an extension of {@link PolyOperandTypeChecker} for implementations which are capable of checking the type of a single operand in isolation. This isn't meaningful for all
