...
public abstract class PolyTypeUtil {
    ...
    public static Class<?> polyToJavaType( PolyType polyType ) {
        switch ( polyType ) {
            ...
            case VARCHAR:
                return String.class;
            case BINARY, TIME_WITH_LOCAL_TIME_ZONE, TIMESTAMP_WITH_LOCAL_TIME_ZONE, INTERVAL_MILLISECONDS, INTERVAL_MONTH, NULL, ANY, SYMBOL, MULTISET, ARRAY, MAP, DISTINCT, STRUCTURED, ROW, OTHER, CURSOR, COLUMN_LIST, DYNAMIC_STAR, GEOMETRY:
                break;
            case VARBINARY:
                return byte[].class;
        }
