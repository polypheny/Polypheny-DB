 ...
 */
public class ParseException extends Exception implements PolyphenyDbParserException {
     ...
     */
    public ParseException( String message, ParserPos pos, int[][] expectedTokenSequences, String[] tokenImages, Throwable parserException ) {
