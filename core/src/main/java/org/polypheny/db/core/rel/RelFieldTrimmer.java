...
/**
 * Transformer that walks over a tree of relational expressions, replacing each {@link RelNode} with a 'slimmed down' relational expression that projects only the columns required by its consumer.
 *
...
public class RelFieldTrimmer implements ReflectiveVisitor {
    ...
    /**
     * Invokes {@link #trimFields}, or the appropriate method for the type of the rel parameter, using multi-method dispatch.
     *
     * @param rel Relational expression
     * @param fieldsUsed Bitmap of fields needed by the consumer
     * @return New relational expression and its field mapping
    ...
    /**
     * Variant of {@link #trimFields(RelNode, ImmutableBitSet, Set)} for {@link Sort}.
     */
    ...
    public TrimResult trimFields( SetOp setOp, ImmutableBitSet fieldsUsed, Set<RelDataTypeField> extraFields ) {
        ...
        // Fennel abhors an empty row type, so pretend that the parent rel wants the last field. (The last field is the least likely to be a system field.)
    ...
    public TrimResult trimFields( Aggregate aggregate, ImmutableBitSet fieldsUsed, Set<RelDataTypeField> extraFields ) {
        ...
        //
        // 1. If agg rel has system fields but none of these are used, create an agg rel with no system fields.
        //
    ...
    /**
     * Variant of {@link #trimFields(RelNode, ImmutableBitSet, Set)} for {@link LogicalTableScan}.
     */
