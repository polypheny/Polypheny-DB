...
public class EnumerableTriggerExecution extends TriggerExecution implements EnumerableAlg {
    ...
    @Override
    public EnumerableTriggerExecution copy(AlgTraitSet traitSet, List<AlgNode> inputs, boolean all ) {
        return new EnumerableTriggerExecution( getCluster(), traitSet, inputs, all );
    }
