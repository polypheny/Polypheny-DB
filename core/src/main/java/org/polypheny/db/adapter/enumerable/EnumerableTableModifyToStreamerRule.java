...
public class EnumerableTableModifyToStreamerRule extends AlgOptRule {
    ...
    public static final EnumerableTableModifyToStreamerRule REL_INSTANCE = new EnumerableTableModifyToStreamerRule( RelModify.class );

    public static final EnumerableTableModifyToStreamerRule DOC_INSTANCE = new EnumerableTableModifyToStreamerRule( DocumentModify.class );

    public static final EnumerableTableModifyToStreamerRule GRAPH_INSTANCE = new EnumerableTableModifyToStreamerRule( LpgModify.class );
