...
/**
 * ParseException defines a checked exception corresponding to {@link Parser}.
 */
public class NodeParseException extends Exception implements PolyphenyDbParserException {
    ...
    @Getter
    public final String[] tokenImages;

    /**
     * The original exception thrown by the generated parser. Unfortunately, each generated parser throws exceptions to a different class. So, we keep the exception for forensic purposes, but don't print it publicly.
     * <p>
     ...
     */
    public NodeParseException( String message, ParserPos pos, int[][] expectedTokenSequences, String[] tokenImages, Throwable parserException ) {
