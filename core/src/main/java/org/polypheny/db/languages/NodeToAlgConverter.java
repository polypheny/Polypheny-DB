...
public interface NodeToAlgConverter {
    ...
    class ConfigBuilder {
        ...
        public ConfigBuilder config( Config config ) {
            this.convertTableAccess = config.convertTableAccess();
            this.decorrelationEnabled = config.decorrelationEnabled();
            this.trimUnusedFields = config.trimUnusedFields();
            this.createValuesAlg = config.createValuesAlg();
            this.explain = config.explain();
            this.expand = config.expand();
            this.inSubQueryThreshold = config.inSubQueryThreshold();
            this.algBuilderFactory = config.algBuilderFactory();
            return this;
        }
