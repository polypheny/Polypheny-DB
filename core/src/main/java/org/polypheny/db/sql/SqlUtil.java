...
public abstract class SqlUtil {
     ...
     *
     * <ul>
     * <li>For {@link SqlLiteral} Unknown, returns false.</li>
     ...
     * Returns whether a node is a literal.
     *
     * Many constructs which require literals also accept <code>CAST(NULL AS <i>type</i>)</code>. This method does not accept casts, so you should call {@link #isNullLiteral} first.
     *
     * @param node The node, never null.
     * @return Whether the node is a literal
     */
     ...
     */
    public static SqlOperator lookupRoutine( SqlOperatorTable opTab, SqlIdentifier funcName, List<RelDataType> argTypes, List<String> argNames, SqlFunctionCategory category, SqlSyntax syntax, SqlKind sqlKind ) {
    ...
    private static Iterator<SqlOperator> filterOperatorRoutinesByKind( Iterator<SqlOperator> routines, final SqlKind sqlKind ) {
     ...
     * @see Glossary#SQL99 SQL:1999 Part 2 Section 10.4
     */
    public static Iterator<SqlOperator> lookupSubjectRoutines( SqlOperatorTable opTab, SqlIdentifier funcName, List<RelDataType> argTypes, List<String> argNames, SqlSyntax sqlSyntax, SqlKind sqlKind, SqlFunctionCategory category ) {
    ...
    private static Iterator<SqlOperator> lookupSubjectRoutinesByName( SqlOperatorTable opTab, SqlIdentifier funcName, final SqlSyntax syntax, SqlFunctionCategory category ) {
