 ...
 */
public class PolyphenyDbContextException extends PolyphenyDbException {
    ...
    /**
     * Creates a new PolyphenyDbContextException object. This constructor is for use by the generated factory.
     *
     * @param message error message
     * @param cause underlying cause, must not be null
     */
    public PolyphenyDbContextException( String message, Throwable cause ) {
        this( message, cause, 0, 0, 0, 0 );
    }


    /**
     * Creates a new PolyphenyDbContextException object.
     *
     * @param message error message
     * @param cause underlying cause, must not be null
     ...
     */
    public PolyphenyDbContextException( String message, Throwable cause, int posLine, int posColumn, int endPosLine, int endPosColumn ) {
        super( message, cause );
        assert cause != null;
     ...
     */
    public PolyphenyDbContextException( String message, Throwable cause, String inputText ) {
        this( message, cause, 0, 0, 0, 0 );
