...
public class SqlFunctions {
    ...
    public static Object jsonValueAny( Object input, SqlJsonValueEmptyOrErrorBehavior emptyBehavior, Object defaultValueOnEmpty, SqlJsonValueEmptyOrErrorBehavior errorBehavior, Object defaultValueOnError ) {
    ...
    public static String jsonQuery( Object input, SqlJsonQueryWrapperBehavior wrapperBehavior, SqlJsonQueryEmptyOrErrorBehavior emptyBehavior, SqlJsonQueryEmptyOrErrorBehavior errorBehavior ) {
        final PathContext context = (PathContext) input;
        final Exception exc;
        if ( context.exc != null ) {
            exc = context.exc;
