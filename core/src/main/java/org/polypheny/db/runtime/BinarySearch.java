...
public class BinarySearch {
    ...
    // Even though this is a utility class (all methods are static), we cannot make the constructor private. Because Janino doesn't do static import,
     ...
     * The method is guaranteed to return the minimal index of the element that is greater or equal to the given key.
     *
     ...
     * @return minimal index of the element that is greater or equal to the given key. Returns -1 when all elements exceed the given key or the array is empty. Returns {@code a.length} when all elements are less than the given key.
     */
    public static <T> int lowerBound( T[] a, T key, Comparator<T> comparator ) {
        return lowerBound( a, key, 0, a.length - 1, Functions.identitySelector(), comparator );
    }
     ...
     * It is assumed that the array is sorted.
     * The method is guaranteed to return the maximal index of the element that is less or equal to the given key.
     *
     * @param a array that holds the values
     * @param key element to look for
     * @param comparator comparator that compares keys
     * @param <T> the type of elements in array
     * @return maximal index of the element that is less or equal to the given key. Returns -1 when all elements are less than the given key or the array is empty. Returns {@code a.length} when all elements exceed the given key.
     */
    public static <T> int upperBound( T[] a, T key, Comparator<T> comparator ) {
        return upperBound( a, key, 0, a.length - 1, Functions.identitySelector(), comparator );
    }
     ...
     * @param a array that holds the values
     * @param key element to look for
     * @param keySelector function that transforms array contents to the type of the key
     * @param comparator comparator that compares keys
     * @param <T> the type of elements in array
    ...
    public static <T> int lowerBound( T[] a, T key, int imin, int imax, Comparator<T> comparator ) {
        return lowerBound( a, key, imin, imax, Functions.identitySelector(), comparator );
    }
    ...
    public static <T> int upperBound( T[] a, T key, int imin, int imax, Comparator<T> comparator ) {
        return upperBound( a, key, imin, imax, Functions.identitySelector(), comparator );
    }
    ...
    public static <T, K> int upperBound( T[] a, K key, int imin, int imax, Function1<T, K> keySelector, Comparator<K> comparator ) {
        ...
        // If imin == initialMax we return initialMax+11 since the resulting window might be empty
