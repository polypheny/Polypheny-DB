...
public final class RelTraitSet extends AbstractList<RelTrait> implements Serializable {
     ...
     *
     * If the set does not contain a trait of the same {@link RelTraitDef}, the trait is ignored, and this trait set is returned.
     *
     ...
     * @see RelTrait#satisfies(RelTrait)
     */
    ...
    /**
     * Returns whether this trait set contains the given trait, or whether the trait is not present because its {@link RelTraitDef} is not enabled.
    ...
    private static class Cache implements Serializable {
        ...
        RelTraitSet getOrAdd( List<RelTrait> traits ) {
            ...
            final RelTraitSet traitSet = new RelTraitSet( this, traits.toArray( new RelTrait[0] ) );
