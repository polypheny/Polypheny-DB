...
/**
 * RelOptCostImpl provides a default implementation for the {@link RelOptCost} interface. It it defined in terms of a single scalar quantity; somewhat
...
public class RelOptCostImpl implements RelOptCost {
    ...
    /**
     * Implementation of {@link RelOptCostFactory} that creates {@link RelOptCostImpl}s.
     */
