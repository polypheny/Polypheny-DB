    ...
    enum Type {
        ...
        public boolean valid( Object defaultValue, Class<?> clazz ) {
            return switch ( this ) {
                ...
                case NUMBER -> Number.class.isAssignableFrom( clazz )
                        && (defaultValue == null || defaultValue instanceof Number);
                case STRING -> clazz == String.class
                        && (defaultValue == null || defaultValue instanceof String);
                case PLUGIN -> clazz != null
                        && (defaultValue == null || defaultValue instanceof String);
                case ENUM -> Enum.class.isAssignableFrom( clazz )
        ...
        public Class<?> defaultValueClass() {
            return switch ( this ) {
                ...
                case PLUGIN -> Object.class;
                default -> throw new AssertionError( "must specify value class for an ENUM" );
            };
        }
    }
