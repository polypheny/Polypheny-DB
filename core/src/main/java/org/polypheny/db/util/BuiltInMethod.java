...
public enum BuiltInMethod {
    ...
    LIST5( ComparableList.class, "of", Object.class, Object.class, Object.class, Object.class, Object.class ),
    LIST6( ComparableList.class, "of", Object.class, Object.class, Object.class, Object.class, Object.class, Object.class ),
    ...
    DOC_SIZE_MATCH( MqlFunctions.class, "docSizeMatch", PolyValue.class, PolyNumber.class ),
    ...
    DOC_SLICE( MqlFunctions.class, "docSlice", PolyValue.class, PolyNumber.class, PolyNumber.class ),
    DOC_QUERY_VALUE( MqlFunctions.class, "docQueryValue", PolyValue.class, List.class ),
    DOC_QUERY_EXCLUDE( MqlFunctions.class, "docQueryExclude", PolyValue.class, List.class ),
    DOC_ADD_FIELDS( MqlFunctions.class, "docAddFields", PolyValue.class, PolyString.class, PolyValue.class ),
    ...
    DOC_REMOVE( MqlFunctions.class, "docRemove", PolyValue.class, List.class ),
    DOC_UPDATE_REPLACE( MqlFunctions.class, "docUpdateReplace", PolyValue.class, List.class, List.class ),
    DOC_UPDATE_RENAME( MqlFunctions.class, "docUpdateRename", PolyValue.class, List.class, List.class ),
    ...
    DOC_MERGE( MqlFunctions.class, "mergeDocument", PolyValue.class, PolyList.class, PolyValue[].class ),
    DOC_RENAME( MqlFunctions.class, "renameDocument", PolyValue.class, PolyString.class, PolyString.class ),

    DOC_REPLACE_ROOT( MqlFunctions.class, "replaceRoot", PolyValue.class ),
