...
/**
 * PolyphenyDbTimingTracer provides a mechanism for tracing the timing of a call sequence at nanosecond resolution.
 */
public class PolyphenyDbTimingTracer {
     ...
     *
     * @param logger logger on which to log timing events; level FINE will be used
     * @param startEvent event to trace as start of timing
     */
    public PolyphenyDbTimingTracer( Logger logger, String startEvent ) {
