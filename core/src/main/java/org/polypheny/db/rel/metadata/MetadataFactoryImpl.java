...
/**
 * Implementation of {@link MetadataFactory} that gets providers from a {@link RelMetadataProvider} and stores them in a cache.
 *
...
public class MetadataFactoryImpl implements MetadataFactory {
    ...
    private static CacheLoader<Pair<Class<RelNode>, Class<Metadata>>, UnboundMetadata<Metadata>> loader( final RelMetadataProvider provider ) {
