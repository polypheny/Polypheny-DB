...
public final class LogicalWindow extends Window {
     ...
     */
    public LogicalWindow( RelOptCluster cluster, RelTraitSet traitSet, RelNode input, List<RexLiteral> constants, RelDataType rowType, List<Group> groups ) {
     ...
     * @param groups Window groups
     */
    public static LogicalWindow create( RelTraitSet traitSet, RelNode input, List<RexLiteral> constants, RelDataType rowType, List<Group> groups ) {
    ...
    public static RelNode create( RelOptCluster cluster, RelTraitSet traitSet, RelBuilder relBuilder, RelNode child, final RexProgram program ) {
        ...
        // They are: the inputs to this rel, followed by the outputs of each window.
