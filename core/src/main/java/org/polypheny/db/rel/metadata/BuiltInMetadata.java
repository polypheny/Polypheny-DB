...
public abstract class BuiltInMetadata {
    ...
    public interface NodeTypes extends Metadata {
        ...
        /**
         * Returns a multimap from the class to the nodes instantiating that class. The default implementation for a node classifies it as a {@link RelNode}.
         */
    ...
    public interface RowCount extends Metadata {
        ...
        /**
         * Estimates the number of rows which will be returned by a relational expression. The default implementation for this query asks the rel itself
         * via {@link RelNode#estimateRowCount}, but metadata providers can override this with their own cost models.
         *
    ...
    public interface PopulationSize extends Metadata {
         ...
         * Typically, "original source" means base table, but for derived columns, the estimate may come from a non-leaf rel such as a LogicalProject.
         *
    ...
    public interface ExpressionLineage extends Metadata {
        ...
        /**
         * Given the input expression applied on the given {@link RelNode}, this provider returns the expression with its lineage resolved.
         *
    ...
    public interface TableReferences extends Metadata {
         ...
         *
         * In particular, the result will be a set of unique table references ({@link RelTableRef}) corresponding to each TableScan operator in the plan. These table references are
    ...
    public interface NonCumulativeCost extends Metadata {
         ...
         * The default implementation for this query asks the rel itself via {@link RelNode#computeSelfCost}, but metadata providers can override this with their own cost models.
         *
         * @return estimated cost, or null if no reliable estimate can be determined
         */
