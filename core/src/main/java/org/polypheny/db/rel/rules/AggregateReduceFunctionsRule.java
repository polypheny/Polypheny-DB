...
public class AggregateReduceFunctionsRule extends RelOptRule {
    ...
    private AggregateCall createAggregateCallWithBinding( RelDataTypeFactory typeFactory, AggFunction aggFunction, RelDataType operandType, Aggregate oldAggRel, AggregateCall oldCall, int argOrdinal, int filter ) {
