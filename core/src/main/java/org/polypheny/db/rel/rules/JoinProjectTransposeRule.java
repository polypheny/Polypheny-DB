...
/**
 * Planner rule that matches a {@link org.polypheny.db.rel.core.Join} one of whose inputs is a {@link org.polypheny.db.rel.logical.LogicalProject}, and pulls the project up.
 *
 * Projections are pulled up if the {@link org.polypheny.db.rel.logical.LogicalProject} doesn't originate from a null generating input in an outer join.
 */
