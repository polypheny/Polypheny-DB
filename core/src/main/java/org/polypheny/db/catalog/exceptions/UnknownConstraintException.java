...
public class UnknownConstraintException extends CatalogException {

    public UnknownConstraintException( String name ) {
        super( "There is no constraint with name: " + name );
    }
