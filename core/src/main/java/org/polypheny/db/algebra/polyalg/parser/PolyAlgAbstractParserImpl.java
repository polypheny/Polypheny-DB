...
public abstract class PolyAlgAbstractParserImpl implements ParserImpl {

    public abstract PolyAlgNode parsePolyAlgEof() throws Exception;
     ...
     * @return clean excn
     */
    public abstract PolyAlgParseException normalizeException( Throwable ex );
