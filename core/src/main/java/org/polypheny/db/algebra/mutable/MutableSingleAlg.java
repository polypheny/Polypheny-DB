...
/**
 * Mutable equivalent of {@link SingleAlg}.
 */
abstract class MutableSingleAlg extends MutableAlg {

    protected MutableAlg input;


    protected MutableSingleAlg( MutableAlgType type, AlgDataType rowType, MutableAlg input ) {
