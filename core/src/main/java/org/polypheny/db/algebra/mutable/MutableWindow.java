...
/**
 * Mutable equivalent of {@link Window}.
 */
public class MutableWindow extends MutableSingleAlg {

    public final List<Group> groups;
    public final List<RexLiteral> constants;


    private MutableWindow( AlgDataType rowType, MutableAlg input, List<Group> groups, List<RexLiteral> constants ) {
        super( MutableAlgType.WINDOW, rowType, input );
        this.groups = groups;
     ...
     */
    public static MutableWindow of( AlgDataType rowType, MutableAlg input, List<Group> groups, List<RexLiteral> constants ) {
