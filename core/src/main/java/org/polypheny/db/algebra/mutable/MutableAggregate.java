...
/**
 * Mutable equivalent of {@link org.polypheny.db.algebra.core.Aggregate}.
 */
public class MutableAggregate extends MutableSingleAlg {
    ...
    private MutableAggregate( MutableAlg input, AlgDataType rowType, ImmutableBitSet groupSet, List<ImmutableBitSet> groupSets, List<AggregateCall> aggCalls ) {
        super( MutableAlgType.AGGREGATE, rowType, input );
     ...
     */
    public static MutableAggregate of( MutableAlg input, ImmutableBitSet groupSet, ImmutableList<ImmutableBitSet> groupSets, List<AggregateCall> aggCalls ) {
        AlgDataType rowType = Aggregate.deriveRowType( input.cluster.getTypeFactory(), input.rowType, false, groupSet, groupSets, aggCalls );
