...
/**
 * Rule to convert an {@link LogicalJoin inner join} to a {@link org.polypheny.db.algebra.logical.LogicalFilter filter} on top of a {@link LogicalJoin cartesian inner join}.
 *
