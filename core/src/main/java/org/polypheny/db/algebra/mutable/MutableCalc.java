 ...
 */
public class MutableCalc extends MutableSingleAlg {

    public final RexProgram program;


    private MutableCalc( MutableAlg input, RexProgram program ) {
        super( MutableAlgType.CALC, program.getOutputRowType(), input );
     ...
     */
    public static MutableCalc of( MutableAlg input, RexProgram program ) {
