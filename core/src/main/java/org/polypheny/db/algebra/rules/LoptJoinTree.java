 ...
 *
 * Because {@link AlgNode}s can be duplicated in a query when you have a self-join, factor ids are needed to distinguish between the different join inputs that correspond to identical tables. The class
...
public class LoptJoinTree {
    ...
    private final AlgNode joinTree;
     ...
     *
     * @param joinTree {@link AlgNode} corresponding to the single node
     * @param factorId factor id of the node
     */
    public LoptJoinTree( AlgNode joinTree, int factorId ) {
     ...
     */
    public LoptJoinTree( AlgNode joinTree, BinaryTree factorTree, boolean removableSelfJoin ) {
        this.joinTree = joinTree;
     ...
     */
    public LoptJoinTree( AlgNode joinTree, BinaryTree leftFactorTree, BinaryTree rightFactorTree ) {
     ...
     */
    public LoptJoinTree( AlgNode joinTree, BinaryTree leftFactorTree, BinaryTree rightFactorTree, boolean removableSelfJoin ) {
