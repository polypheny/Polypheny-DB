...
/**
 * Mapping from an input column of a {@link AlgNode} to one of its output columns.
 */
public class AlgColumnMapping {

    public AlgColumnMapping( int iOutputColumn, int iInputRel, int iInputColumn, boolean derived ) {
    ...
    /**
     * 0-based ordinal of mapped input alg.
     */
    public final int iInputRel;

    /**
     * 0-based ordinal of mapped column within input alg.
     */
