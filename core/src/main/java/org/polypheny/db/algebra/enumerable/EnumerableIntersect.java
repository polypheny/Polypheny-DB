...
/**
 * Implementation of {@link org.polypheny.db.algebra.core.Intersect} in {@link EnumerableConvention enumerable calling convention}.
 */
public class EnumerableIntersect extends Intersect implements EnumerableAlg {

    public EnumerableIntersect( AlgCluster cluster, AlgTraitSet traitSet, List<AlgNode> inputs, boolean all ) {
