 ...
 * <p>
 * Typically, the aggregation implementation will convert {@link #accumulator()} to the resulting value of the aggregation.  The implementation MUST NOT destroy the contents of {@link #accumulator()}.
 */
public interface WinAggResultContext extends AggResultContext, WinAggFrameResultContext {
     ...
     *
     * @param rowIndex index of the requested row. The index must be in range of partition's startIndex and endIndex.
