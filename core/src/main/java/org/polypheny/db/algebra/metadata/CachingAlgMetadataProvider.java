...
/**
 * Implementation of the {@link AlgMetadataProvider} interface that caches results from an underlying provider.
 */
public class CachingAlgMetadataProvider implements AlgMetadataProvider {
    ...
    /**
     * Implementation of {@link InvocationHandler} for calls to a {@link CachingAlgMetadataProvider}. Each request first looks in the cache;
