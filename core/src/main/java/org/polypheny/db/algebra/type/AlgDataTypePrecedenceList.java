...
/**
 * {@link AlgDataTypePrecedenceList} defines a type precedence list for a particular type.
 *
 * @see Glossary#SQL99 SQL:1999 Part 2 Section 9.5
 */
public interface AlgDataTypePrecedenceList {
     ...
     */
    boolean containsType( AlgDataType type );
