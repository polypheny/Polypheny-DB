...
/**
 * Tests the generated implementation of {@link PolyphenyDbResource} (mostly a sanity check for the resource-generation infrastructure).
 */
public class PolyphenyDbResourceTest {

    public PolyphenyDbResourceTest() {
    }
