...
public abstract class SqlOperatorBaseTest {
    ...
    */
    ...
    public void testMultisetUnionOperator() {
        tester.setFor( SqlStdOperatorTable.MULTISET_UNION_DISTINCT, VM_FENNEL, VM_JAVA );
    ...
    public void testMultisetUnionAllOperator() {
        tester.setFor( SqlStdOperatorTable.MULTISET_UNION, VM_FENNEL, VM_JAVA );
        tester.checkScalar(
    ...
    public void testSubMultisetOfOperator() {
        tester.setFor( SqlStdOperatorTable.SUBMULTISET_OF, VM_FENNEL, VM_JAVA );
    ...
    public void testNotSubMultisetOfOperator() {
        tester.setFor( SqlStdOperatorTable.NOT_SUBMULTISET_OF, VM_FENNEL, VM_JAVA );
