...
import org.polypheny.db.sql.sql.parser.SqlAbstractParserImpl;
...
import org.polypheny.db.sql.sql.validate.SqlUserDefinedAggFunction;
import org.polypheny.db.sql.sql.validate.SqlUserDefinedFunction;
...
public class SqLanguagelDependant extends LanguageManager {

    static {
        LanguageManager.setAndGetInstance( new SqLanguagelDependant() );
    }
