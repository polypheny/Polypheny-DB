...
package org.polypheny.db.sql.sql.util;
...
/**
 * Extension to {@link StringBuilder} for the purposes of creating SQL queries and expressions.
 *
 * Using this class helps to prevent SQL injection attacks, incorrectly quoted identifiers and strings. These problems occur when you build SQL by concatenating strings, and you forget to treat identifers and string literals
 * correctly. SqlBuilder has special methods for appending identifiers and literals.
 */
public class SqlBuilder {
     ...
     *
     * Use this method in preference to {@link #toString()}. It indicates that the SQL string has been constructed using good hygiene, and is therefore less likely to contain SQL injection or badly quoted
     ...
     *
     * For example, calling <code>literal(&quot;can't&quot;)</code> would convert the buffer <blockquote><code>SELECT </code></blockquote>
     * to
