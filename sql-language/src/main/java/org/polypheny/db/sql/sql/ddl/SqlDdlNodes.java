...
public class SqlDdlNodes {
     ...
     */
    public static SqlCreateProcedure createProcedure(ParserPos pos, boolean replace, boolean ifNotExists, SqlIdentifier name, SqlNode query, SqlNodeList arguments ) {
        return new SqlCreateProcedure( pos, replace, ifNotExists, name, query, arguments);
    }

    /**
     * Executes a PROCEDURE.
     */
    public static SqlExecuteProcedure executeProcedure(ParserPos pos, SqlIdentifier name, List<SqlNode> arguments ) {
    ...
    /**
     * Creates a DROP PROCEDURE.
     */
    public static SqlDrop dropProcedure( ParserPos pos, boolean ifExists, SqlIdentifier name ) {
