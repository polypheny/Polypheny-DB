...
public class PostgresqlSqlDialect extends SqlDialect {
    ...
    public Object getVectorDbObject( VectorType.ElementType vectorType, PolyList<PolyValue> vectorAsList ) {
        return switch ( vectorType ) {
            case FLOAT -> {
                if ( vectorAsList instanceof PolyFloatList<?> pfl ) yield new PGvector( pfl.getRawValue() );
                else throw new UnsupportedOperationException("Provided VectorType with ElementType 'FLOAT' but vector was no PolyFloatList<>");
            }
