...
public class Smalls {
    ...
    public static final Method STR_METHOD = Types.lookupMethod( Smalls.class, "str", Object.class, Object.class );
    public static final Method STRING_UNION_METHOD = Types.lookupMethod( Smalls.class, "stringUnion", Queryable.class, Queryable.class );
    public static final Method PROCESS_CURSOR_METHOD = Types.lookupMethod( Smalls.class, "processCursor", int.class, Enumerable.class );
    public static final Method PROCESS_CURSORS_METHOD = Types.lookupMethod( Smalls.class, "processCursors", int.class, Enumerable.class, Enumerable.class );
    ...
    /**
     * Example of a UDF with a non-static {@code eval} method, and named parameters.
     */
    ...
    public static class MyAbcdeFunction {
        ...
        public String eval(
                @Parameter(name = "A", optional = false) Integer a,
    ...
    /**
     * Example of a picky, semi-strict UDF. Throws {@link NullPointerException} if argument is null.
    ...
    /**
     * Example of a UDF with a static {@code eval} method. Class is abstract, but code-generator should not need to instantiate it.
     */
    ...
    public static class AllTypesFunction {
        ...
        // We use SqlFunctions.toLong(Date) ratter than Date.getTime(), and SqlFunctions.internalToTimestamp(long) rather than new Date(long),
        // because the contract of JDBC (also used by UDFs) is to represent date-time values in the LOCAL time zone.
    ...
    /**
     * Example of a user-defined aggregate function (UDAF), whose methods are static. olny for validate to get exact function by Polypheny-DB
     */
    ...
    /**
     * A table function that returns a {@link QueryableTable} via a static method.
     */
