 ...
 *
 * The standard set of row-level functions and operators are declared in class {@link org.polypheny.db.sql.language.fun.SqlStdOperatorTable}. Anonymous inner classes within that
