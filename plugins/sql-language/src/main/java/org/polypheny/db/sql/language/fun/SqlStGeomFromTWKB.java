 ...
 */
public class SqlStGeomFromTWKB extends SqlFunction {

    /**
     * Creates the SqlStGeomFromTWKB.
     */
    public SqlStGeomFromTWKB() {
        super( "ST_GEOMFROMTWKB", Kind.GEO, ReturnTypes.GEOMETRY, null, ST_GEOMFROMTEXT_ARG_CHECKER, FunctionCategory.GEOMETRY );
    }
