...
import static org.polypheny.db.workflow.dag.activities.impl.special.NestedInputActivity.INDEX_KEY;
...
@ActivityDefinition(type = "nestedInput", displayName = "Nested Workflow Input", categories = { ActivityCategory.RELATIONAL, ActivityCategory.DOCUMENT, ActivityCategory.GRAPH, ActivityCategory.EXTRACT, ActivityCategory.NESTED },
