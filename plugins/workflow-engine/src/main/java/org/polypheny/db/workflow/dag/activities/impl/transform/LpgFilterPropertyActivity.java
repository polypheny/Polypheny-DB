...
@ActivityDefinition(type = "lpgPropertyFilter", displayName = "Filter Graph by Properties", categories = { ActivityCategory.TRANSFORM, ActivityCategory.GRAPH, ActivityCategory.CLEANING, ActivityCategory.ESSENTIALS },
...
@FieldSelectSetting(key = "requiredFields", displayName = "Required Properties", simplified = true, pos = 0,
...
@FilterSetting(key = "filter", displayName = "Conditions", pos = 1,
        modes = { SelectMode.EXACT, SelectMode.REGEX }, targetInput = 0,
...
@FieldSelectSetting(key = "labels", displayName = "Targets", simplified = true, pos = 0, group = GroupDef.ADVANCED_GROUP,
