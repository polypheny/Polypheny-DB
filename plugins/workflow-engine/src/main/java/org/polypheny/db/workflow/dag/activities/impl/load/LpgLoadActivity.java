...
@ActivityDefinition(type = "lpgLoad", displayName = "Load Graph to Polypheny", categories = { ActivityCategory.LOAD, ActivityCategory.GRAPH, ActivityCategory.ESSENTIALS },
