...
@ActivityDefinition(type = "anyToLpg", displayName = "Construct Graph", categories = { ActivityCategory.TRANSFORM, ActivityCategory.GRAPH, ActivityCategory.RELATIONAL, ActivityCategory.DOCUMENT, ActivityCategory.CROSS_MODEL, ActivityCategory.ESSENTIALS },
        inPorts = {
