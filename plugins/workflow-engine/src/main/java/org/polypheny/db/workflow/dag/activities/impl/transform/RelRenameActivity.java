...
@ActivityDefinition(type = "renameCols", displayName = "Rename Columns", categories = { ActivityCategory.TRANSFORM, ActivityCategory.RELATIONAL, ActivityCategory.CLEANING, ActivityCategory.ESSENTIALS },
