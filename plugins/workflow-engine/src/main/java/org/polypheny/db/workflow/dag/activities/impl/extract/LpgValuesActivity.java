...
@ActivityDefinition(type = "lpgValues", displayName = "Generate Random Graph", categories = { ActivityCategory.EXTRACT, ActivityCategory.GRAPH, ActivityCategory.DEVELOPMENT },
        inPorts = {},
