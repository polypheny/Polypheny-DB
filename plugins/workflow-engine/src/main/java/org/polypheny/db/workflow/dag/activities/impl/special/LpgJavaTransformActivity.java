...
@ActivityDefinition(type = "lpgJavaTransform", displayName = "Graph Java Transform", categories = { ActivityCategory.TRANSFORM, ActivityCategory.GRAPH, ActivityCategory.EXTERNAL },
