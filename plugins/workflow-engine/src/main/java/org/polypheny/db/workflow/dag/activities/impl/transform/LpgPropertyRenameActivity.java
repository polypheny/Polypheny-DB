...
@ActivityDefinition(type = "lpgPropertyRename", displayName = "Rename Graph Properties", categories = { ActivityCategory.TRANSFORM, ActivityCategory.GRAPH, ActivityCategory.CLEANING, ActivityCategory.ESSENTIALS },
