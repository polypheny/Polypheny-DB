...
import static org.polypheny.db.workflow.dag.activities.impl.load.DocLoadActivity.COLL_KEY;
...
@ActivityDefinition(type = "docLoad", displayName = "Load Collection to Polypheny", categories = { ActivityCategory.LOAD, ActivityCategory.DOCUMENT, ActivityCategory.ESSENTIALS },
