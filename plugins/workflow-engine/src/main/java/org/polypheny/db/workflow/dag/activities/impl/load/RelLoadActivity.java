...
import static org.polypheny.db.workflow.dag.activities.impl.load.RelLoadActivity.TABLE_KEY;
...
@ActivityDefinition(type = "relLoad", displayName = "Load Table to Polypheny", categories = { ActivityCategory.LOAD, ActivityCategory.RELATIONAL, ActivityCategory.ESSENTIALS },
