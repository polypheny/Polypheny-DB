...
@ActivityDefinition(type = "docFilter", displayName = "Filter Documents", categories = { ActivityCategory.TRANSFORM, ActivityCategory.DOCUMENT },
        ...
        outPorts = {
                ...
                @OutPort(type = PortType.DOC, description = "A table containing all documents that did not meet the filter criteria.")
        },
...
@BoolSetting(key = "all", displayName = "Match Subfields", pos = 1,
...
@FilterSetting(key = "filter", displayName = "Filter Conditions", pos = 2,
        modes = { SelectMode.EXACT, SelectMode.REGEX })
@BoolSetting(key = "negate", displayName = "Negate Filter", pos = 3, defaultValue = false,
