...
@ActivityDefinition(type = "nestedOutput", displayName = "Nested Workflow Outputs", categories = { ActivityCategory.RELATIONAL, ActivityCategory.DOCUMENT, ActivityCategory.GRAPH, ActivityCategory.LOAD, ActivityCategory.NESTED },
