...
@ActivityDefinition(type = "docRename", displayName = "Rename Document Fields", categories = { ActivityCategory.TRANSFORM, ActivityCategory.DOCUMENT, ActivityCategory.CLEANING, ActivityCategory.ESSENTIALS },
