...
@ActivityDefinition(type = "lpgIdentity", displayName = "Graph Identity", categories = { ActivityCategory.TRANSFORM, ActivityCategory.GRAPH, ActivityCategory.DEVELOPMENT },
