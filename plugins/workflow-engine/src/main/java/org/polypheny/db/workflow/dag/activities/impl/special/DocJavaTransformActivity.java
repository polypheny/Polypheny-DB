...
@ActivityDefinition(type = "docJavaTransform", displayName = "Document Java Transform", categories = { ActivityCategory.TRANSFORM, ActivityCategory.DOCUMENT, ActivityCategory.EXTERNAL },
