...
import static org.polypheny.db.workflow.dag.activities.impl.extract.LpgExtractActivity.GRAPH_KEY;
...
public class LpgExtractActivity implements Activity, Pipeable {
    ...
    public String getDynamicName( List<TypePreview> inTypes, SettingsPreview settings ) {
        ...
        return graph.map( v -> String.format( "Extract Graph '%s'", v.getGraphName() ) ).orElse( null );
    }
