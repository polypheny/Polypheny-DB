...
//
//        final Map<String, String> mappings = ImmutableMap.of( "a", "long", "b.a", "long", "b.b", "long", "b.c.a", "keyword" );
//
...
//
//        final PolyphenyDbAssert.AssertThat factory = PolyphenyDbAssert.that().with( newConnectionFactory() );
//
//        factory
...
//
//        // single _id column
//        final String sql1 = String.format( Locale.ROOT, "select _MAP['_id'] from \"elastic\".\"%s\"", NAME );
//        factory
//                .query( sql1 )
//                .returns( regexMatch( "EXPR$0=\\p{Graph}+" ) );
//
//        // multiple columns: _id and a
//        final String sql2 = String.format( Locale.ROOT, "select _MAP['_id'], _MAP['a'] from \"elastic\".\"%s\"", NAME );
//        factory
//                .query( sql2 )
//                .returns( regexMatch( "EXPR$0=\\p{Graph}+; EXPR$1=1" ) );
//
//        // multiple _id columns
//        final String sql3 = String.format( Locale.ROOT, "select _MAP['_id'], _MAP['_id'] from \"elastic\".\"%s\"", NAME );
//        factory
//                .query( sql3 )
//                .returns( regexMatch( "EXPR$0=\\p{Graph}+; EXPR$1=\\p{Graph}+" ) );
//
//        // _id column with same alias
//        final String sql4 = String.format( Locale.ROOT, "select _MAP['_id'] as \"_id\" from \"elastic\".\"%s\"", NAME );
//        factory
//                .query( sql4 )
...
//     * @return consumer to be used in {@link AssertQuery}
//     */
