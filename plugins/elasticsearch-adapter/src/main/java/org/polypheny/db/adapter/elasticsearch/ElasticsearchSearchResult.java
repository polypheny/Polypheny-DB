...
/**
 * Internal object used to parse elastic search result. Similar to {@code SearchHit}. Since we're using row-level rest client the response has to be processed manually.
 */
...
public class ElasticsearchSearchResult {
     ...
     */
    @JsonCreator
    ElasticsearchSearchResult( @JsonProperty("hits") SearchHits hits, @JsonProperty("took") long took ) {
    ...
    public static class SearchHit {
        ...
        @JsonCreator
        private SearchHit( @JsonProperty("_id") final String id, @JsonProperty("_source") final Map<String, Object> source, @JsonProperty("fields") final Map<String, Object> fields ) {
        ...
        Object value( String name ) {
            ...
            if ( !sourceOrFields().containsKey( name ) ) {
                final String message = String.format( Locale.ROOT, "Attribute %s not found in search result %s", name, id );
                throw new IllegalArgumentException( message );
            }
