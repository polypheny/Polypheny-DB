...
/**
 * A generic aggregate enumerator that goes row by row (using PolyValue[] for a row) and aggregates the columns.
 */
public class ParquetRowAggregateRelEnumerator extends AbstractAggregateEnumerator {
     ...
     */
    public ParquetRowAggregateRelEnumerator( Enumerator<PolyValue[]> rows, int[] groupFields, String[] aggregateKinds, int[] aggregateArgs ) {
