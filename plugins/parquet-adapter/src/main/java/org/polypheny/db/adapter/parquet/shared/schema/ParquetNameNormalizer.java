 ...
 */
public final class ParquetNameNormalizer {

    private ParquetNameNormalizer() {
    }
    ...
    public static String computePhysicalTableName( String fileName ) {
     ...
     */
    public static void uniquifyParquetFieldNames( List<FieldSchema> fields ) {
        ...
        for ( FieldSchema field : fields ) {
            ...
            if ( field.getValueSchema().kind() == ValueKind.GROUP ) {
                uniquifyParquetFieldNames( field.getValueSchema().nested() );
            }
        }
    }
