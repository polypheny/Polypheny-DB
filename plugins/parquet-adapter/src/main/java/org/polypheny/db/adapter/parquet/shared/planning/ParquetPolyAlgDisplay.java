...
package org.polypheny.db.adapter.parquet.shared.planning;
...
public final class ParquetPolyAlgDisplay {

    private ParquetPolyAlgDisplay() {
    }


    public static List<String> fieldNames( PhysicalEntity entity, int[] fields ) {
        List<AlgDataTypeField> tableFields = entity.getTupleType().getFields();
    ...
    public static List<String> fieldNames( PhysicalEntity entity ) {
        List<AlgDataTypeField> tableFields = entity.getTupleType().getFields();
    ...
    public static List<String> prefixedFieldNames( PhysicalEntity entity, String prefix ) {
        return fieldNames( entity ).stream()
                .map( fieldName -> prefix + "." + fieldName )
                .toList();
    }


    public static List<String> filters( List<ParquetAdapterFilter<PolyValue>> filters, List<String> fieldNames ) {
    ...
    public static String filter( ParquetAdapterFilter<PolyValue> filter, List<String> fieldNames ) {
        if ( filter.isLogical() ) {
    ...
    public static List<String> joinedFieldNames( ParquetRelTable leftTable, int[] leftFields, ParquetRelTable rightTable, int[] rightFields ) {
