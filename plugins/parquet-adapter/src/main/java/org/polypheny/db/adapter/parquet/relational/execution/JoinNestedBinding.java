...
public record JoinNestedBinding(ParquetTableBinding table, List<ParquetColumnBinding> columns, List<ParquetColumnBinding> filterColumns ) {

    public JoinNestedBinding {
