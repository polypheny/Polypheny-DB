...
public class ParquetTableScan extends RelScan<ParquetTable> implements EnumerableAlg {

    private final int[] fields;


    public ParquetTableScan(AlgCluster cluster, ParquetTable table, int[] fields ) {
    ...
    public AlgNode copy( AlgTraitSet traitSet, List<AlgNode> inputs ) {
        return new ParquetTableScan( getCluster(), entity, fields );
    }
    ...
    public void register( AlgPlanner planner ) {
        planner.addRule( ParquetTableScanRule.INSTANCE );
    }
