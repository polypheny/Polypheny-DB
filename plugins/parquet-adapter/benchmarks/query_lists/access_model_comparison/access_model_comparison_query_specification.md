...
|-------|---------------------|----------------------------------------------------|----------------------------------------------------|------------------------------------------------------------|
| Q01   | Full record or document access | None                                      | All fields                                         | Measures full dataset read performance                     |
...
| Q04   | Filtered full record or document access | `trip_distance >= 10.0` and `total_amount >= 40.0` | All matching records or documents                  | Measures filtering with full result consumption            |
...
## Q1 - Full record or document access
...
## Q4 - Filtered full record or document access
