...
|---------------------------------|------|-----------|-----------|-----------|-----------|-------------|---------|---------|--------|
| Polypheny Relational Normalized | 5/5  | 2,463.6   | 2,515.0   | 744.8     | 1,560.0   | 3,595.0     | 100,000 | 9       | ok     |
| Polypheny Document MQL          | 5/5  | 233,059.4 | 233,429.0 | 2,193.3   | 230,546.0 | 235,220.0   | 100,000 | 10      | ok     |
| DuckDB                          | 5/5  | 504,359.8 | 298,765.0 | 502,681.7 | 208,355.0 | 1,400,388.0 | 100,000 | 9       | ok     |
| Apache Spark                    | 5/5  | 77,967.0  | 79,575.0  | 3,057.8   | 72,722.0  | 80,006.0    | 100,000 | 9       | ok     |

### Q02 - Filtered explicit customer projection

| System                          | Runs | Mean      | Median    | Std Dev | Min       | Max       | Rows    | Columns | Status |
|---------------------------------|------|-----------|-----------|---------|-----------|-----------|---------|---------|--------|
| Polypheny Relational Normalized | 5/5  | 1,176.8   | 1,169.0   | 176.9   | 953.0     | 1,446.0   | 100,000 | 8       | ok     |
| Polypheny Document MQL          | 5/5  | 122,618.4 | 124,246.0 | 2,871.3 | 118,223.0 | 125,141.0 | 100,000 | 9       | ok     |
| DuckDB                          | 5/5  | 640.4     | 646.0     | 82.2    | 557.0     | 745.0     | 100,000 | 8       | ok     |
| Apache Spark                    | 5/5  | 1,752.0   | 1,706.0   | 137.2   | 1,590.0   | 1,928.0   | 100,000 | 8       | ok     |

### Q03 - One-join filtered order element projection

| System                          | Runs | Mean     | Median   | Std Dev | Min      | Max       | Rows    | Columns | Status        |
|---------------------------------|------|----------|----------|---------|----------|-----------|---------|---------|---------------|
| Polypheny Relational Normalized | 5/5  | 2,727.8  | 2,599.0  | 300.1   | 2,400.0  | 3,132.0   | 100,000 | 8       | ok            |
| Polypheny Document MQL          | 0/5  |          |          |         |          |           |         |         | not supported |
| DuckDB                          | 5/5  | 96,091.4 | 97,781.0 | 8,018.8 | 86,416.0 | 103,882.0 | 100,000 | 6       | ok            |
| Apache Spark                    | 5/5  | 13,420.6 | 13,513.0 | 950.1   | 12,002.0 | 14,677.0  | 100,000 | 6       | ok            |

### Q04 - One-join filtered lineitem element projection

| System                          | Runs | Mean        | Median      | Std Dev   | Min       | Max         | Rows    | Columns | Status        |
|---------------------------------|------|-------------|-------------|-----------|-----------|-------------|---------|---------|---------------|
| Polypheny Relational Normalized | 5/5  | 10,845.6    | 10,887.0    | 281.1     | 10,373.0  | 11,094.0    | 100,000 | 10      | ok            |
| Polypheny Document MQL          | 0/5  |             |             |           |           |             |         |         | not supported |
| DuckDB                          | 5/5  | 1,575,230.8 | 1,721,657.0 | 563,393.3 | 828,355.0 | 2,198,427.0 | 100,000 | 8       | ok            |
| Apache Spark                    | 5/5  | 16,749.2    | 17,154.0    | 1,060.4   | 14,952.0  | 17,544.0    | 100,000 | 8       | ok            |

### Q05 - Nested lineitem MAX aggregation grouped by return flag

| System                          | Runs | Mean        | Median      | Std Dev     | Min         | Max         | Rows | Columns | Status        |
|---------------------------------|------|-------------|-------------|-------------|-------------|-------------|------|---------|---------------|
| Polypheny Relational Normalized | 5/5  | 222,409.4   | 220,801.0   | 12,599.5    | 206,076.0   | 240,681.0   | 3    | 2       | ok            |
| Polypheny Document MQL          | 0/5  |             |             |             |             |             |      |         | not supported |
| DuckDB                          | 5/5  | 3,724,019.2 | 3,103,441.0 | 1,343,512.3 | 3,050,067.0 | 6,123,072.0 | 3    | 2       | ok            |
| Apache Spark                    | 5/5  | 15,316.4    | 15,376.0    | 322.4       | 14,800.0    | 15,608.0    | 3    | 2       | ok            |
