...
//
//    /**
//     * Test case for "Druid adapter: Send timestamp literals to Druid as local time, not UTC".
//     */
//    @Test
...
//
//    /**
//     * Test case for "Druid adapter wrongly returns all numeric values as int or float".
//     */
//    @Test
...
//
//    /**
//     * Test case for "Druid adapter: wrong semantics of topN query limit with granularity".
//     */
//    @Test
...
//
//    /**
//     * Test case for "Druid adapter: topN returns approximate results".
//     */
//    @Test
...
//
//    /**
//     * Test case for "Druid adapter: wrong semantics of groupBy query limit with granularity".
//     *
...
//     * Test case for "Druid adapter: wrong semantics of groupBy query limit with granularity".
//     *
//     * Before this bug was fixed, this would use a "groupBy" query but wrongly try to use a {@code limitSpec} to sort and filter. (A "topN" query was not possible because the sort was {@code ASC}.)
//     */
//    @Test
...
//
//    /**
//     * Test case for "Druid adapter: Wrong semantics for ordering within groupBy queries".
//     */
//    @Test
...
//
//    /**
//     * Test case for "Druid adapter: Incorrect result - limit on timestamp disappears".
//     */
//    @Test
...
//
//    /**
//     * Tests that distinct-count is pushed down to Druid and evaluated using "cardinality". The result is approximate, but gives the correct result in
...
//     *
//     * Test case for "Convert predicates on EXTRACT function calls into date ranges".
//     */
//    @Test
...
//
//    /**
//     * Test case for "Druid adapter: Gracefully handle granularity that cannot be pushed to extraction function".
//     */
//    @Test
...
//
//    /**
//     * Test case for "Druid adapter: CAST(NULL AS ...) gives NPE".
//     */
//    @Test
...
//
//    /**
//     * Test case for "Druid adapter: Push down filters involving numeric cast of literals".
//     */
//    @Test
...
//
//    /**
//     * Test case for "Druid adapter cannot handle count column without adding support for nested queries".
//     */
//    @Test
...
//
//    /**
//     * Test to make sure that the mapping from a Table name to a Table returned from {@link DruidSchema} is always the same Java object.
//     */
//    @Test
//    public void testTableMapReused() {
//        AbstractSchema schema = new DruidSchema( "http://localhost:8082", "http://localhost:8081", true );
//        assertSame( schema.getLogicalTable( "wikiticker" ), schema.getLogicalTable( "wikiticker" ) );
//    }
//
//
//    @Test
...
//
//    /**
//     * Test case for "DateRangeRules issues".
//     */
//    @Test
...
//
//    /**
//     * Test case for "Need to make sure that when there we have a valid filter with no conjunction we still push all the valid filters".
//     */
//    @Test
...
//
//    /**
//     * Test case for "Bug in the Druid Filter Translation when Comparing String Ref to a Constant Number".
//     */
//    @Test
...
//
//    /**
//     * Test case for "Druid adapter: Allow count(*) to be pushed when other aggregate functions are present"
//      */
//    @Test
