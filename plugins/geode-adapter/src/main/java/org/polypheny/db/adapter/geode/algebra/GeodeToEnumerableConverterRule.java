...
/**
 * Rule to convert a relational expression from {@link GeodeAlg#CONVENTION} to {@link EnumerableConvention}.
 */
public class GeodeToEnumerableConverterRule extends ConverterRule {
    ...
    private GeodeToEnumerableConverterRule() {
        super( AlgNode.class, GeodeAlg.CONVENTION, EnumerableConvention.INSTANCE, "GeodeToEnumerableConverterRule" );
    }
    ...
    public AlgNode convert( AlgNode alg ) {
        ...
        return new GeodeToEnumerableConverter( alg.getCluster(), newTraitSet, alg );
    }
