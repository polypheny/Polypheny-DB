...
public interface MonitoringQueueWorker<TEvent extends MonitoringEventData, TPersistent extends MonitoringPersistentData> {

    public void handleJob(MonitoringJob<TEvent, TPersistent> job);
}
