...
public class DruidQuery extends AbstractRelNode implements BindableRel {
    ...
    public static final List<DruidSqlOperatorConverter> DEFAULT_OPERATORS_LIST =
            ImmutableList.<DruidSqlOperatorConverter>builder()
                    .add( new DirectOperatorConversion( StdOperatorRegistry.get( OperatorName.EXP ), "exp" ) )
                    .add( new DirectOperatorConversion( StdOperatorRegistry.get( OperatorName.CONCAT ), "concat" ) )
                    .add( new DirectOperatorConversion( StdOperatorRegistry.get( OperatorName.DIVIDE_INTEGER ), "div" ) )
                    .add( new DirectOperatorConversion( StdOperatorRegistry.get( OperatorName.LIKE ), "like" ) )
                    .add( new DirectOperatorConversion( StdOperatorRegistry.get( OperatorName.LN ), "log" ) )
                    .add( new DirectOperatorConversion( StdOperatorRegistry.get( OperatorName.SQRT ), "sqrt" ) )
                    .add( new DirectOperatorConversion( StdOperatorRegistry.get( OperatorName.LOWER ), "lower" ) )
                    .add( new DirectOperatorConversion( StdOperatorRegistry.get( OperatorName.LOG10 ), "log10" ) )
                    .add( new DirectOperatorConversion( StdOperatorRegistry.get( OperatorName.REPLACE ), "replace" ) )
                    .add( new DirectOperatorConversion( StdOperatorRegistry.get( OperatorName.UPPER ), "upper" ) )
                    .add( new DirectOperatorConversion( StdOperatorRegistry.get( OperatorName.POWER ), "pow" ) )
                    .add( new DirectOperatorConversion( StdOperatorRegistry.get( OperatorName.ABS ), "abs" ) )
                    .add( new DirectOperatorConversion( StdOperatorRegistry.get( OperatorName.SIN ), "sin" ) )
                    .add( new DirectOperatorConversion( StdOperatorRegistry.get( OperatorName.COS ), "cos" ) )
                    .add( new DirectOperatorConversion( StdOperatorRegistry.get( OperatorName.TAN ), "tan" ) )
                    .add( new DirectOperatorConversion( StdOperatorRegistry.get( OperatorName.CASE ), "case_searched" ) )
                    .add( new DirectOperatorConversion( StdOperatorRegistry.get( OperatorName.CHAR_LENGTH ), "strlen" ) )
                    .add( new DirectOperatorConversion( StdOperatorRegistry.get( OperatorName.CHARACTER_LENGTH ), "strlen" ) )
                    .add( new BinaryOperatorConversion( StdOperatorRegistry.get( OperatorName.EQUALS ), "==" ) )
                    .add( new BinaryOperatorConversion( StdOperatorRegistry.get( OperatorName.NOT_EQUALS ), "!=" ) )
                    .add( new NaryOperatorConverter( StdOperatorRegistry.get( OperatorName.OR ), "||" ) )
                    .add( new NaryOperatorConverter( StdOperatorRegistry.get( OperatorName.AND ), "&&" ) )
                    .add( new BinaryOperatorConversion( StdOperatorRegistry.get( OperatorName.LESS_THAN ), "<" ) )
                    .add( new BinaryOperatorConversion( StdOperatorRegistry.get( OperatorName.LESS_THAN_OR_EQUAL ), "<=" ) )
                    .add( new BinaryOperatorConversion( StdOperatorRegistry.get( OperatorName.GREATER_THAN ), ">" ) )
                    .add( new BinaryOperatorConversion( StdOperatorRegistry.get( OperatorName.GREATER_THAN_OR_EQUAL ), ">=" ) )
                    .add( new BinaryOperatorConversion( StdOperatorRegistry.get( OperatorName.PLUS ), "+" ) )
                    .add( new BinaryOperatorConversion( StdOperatorRegistry.get( OperatorName.MINUS ), "-" ) )
                    .add( new BinaryOperatorConversion( StdOperatorRegistry.get( OperatorName.MULTIPLY ), "*" ) )
                    .add( new BinaryOperatorConversion( StdOperatorRegistry.get( OperatorName.DIVIDE ), "/" ) )
                    .add( new BinaryOperatorConversion( StdOperatorRegistry.get( OperatorName.MOD ), "%" ) )
                    .add( new DruidSqlCastConverter() )
                    .add( new ExtractOperatorConversion() )
                    .add( new UnaryPrefixOperatorConversion( StdOperatorRegistry.get( OperatorName.NOT ), "!" ) )
                    .add( new UnaryPrefixOperatorConversion( StdOperatorRegistry.get( OperatorName.UNARY_MINUS ), "-" ) )
                    .add( new UnarySuffixOperatorConversion( StdOperatorRegistry.get( OperatorName.IS_FALSE ), "<= 0" ) )
                    .add( new UnarySuffixOperatorConversion( StdOperatorRegistry.get( OperatorName.IS_NOT_TRUE ), "<= 0" ) )
                    .add( new UnarySuffixOperatorConversion( StdOperatorRegistry.get( OperatorName.IS_TRUE ), "> 0" ) )
                    .add( new UnarySuffixOperatorConversion( StdOperatorRegistry.get( OperatorName.IS_NOT_FALSE ), "> 0" ) )
                    .add( new UnarySuffixOperatorConversion( StdOperatorRegistry.get( OperatorName.IS_NULL ), "== null" ) )
                    .add( new UnarySuffixOperatorConversion( StdOperatorRegistry.get( OperatorName.IS_NOT_NULL ), "!= null" ) )
