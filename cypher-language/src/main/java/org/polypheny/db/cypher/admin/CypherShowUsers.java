...
@Getter
public class CypherShowUsers extends CypherWithGraph {
    ...
    public CypherShowUsers( ParserPos pos, CypherYield yield, CypherReturnClause returnClause, CypherWhere where ) {
        super( pos );
        this.yield = yield;
