...
@Getter
public class CypherGrantPrivilege extends CypherAdminCommand implements UnsupportedExecutableStatement {

    private final List<CypherSimpleEither<String, CypherParameter>> roles;
    private final CypherPrivilegeType privilege;


    public CypherGrantPrivilege( ParserPos pos, List<CypherSimpleEither<String, CypherParameter>> roles, CypherPrivilegeType privilege ) {
        super( pos );
        this.roles = roles;
