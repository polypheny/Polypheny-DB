...
public class CypherSyntaxExecption extends NodeParseException {
     ...
     */
    public CypherSyntaxExecption( String message, ParserPos pos, int[][] expectedTokenSequences, String[] tokenImages, Throwable parserException ) {
        super( message, pos, expectedTokenSequences, tokenImages, parserException );
    }


    public CypherSyntaxExecption( ParseException e, int beginOffset, int beginLine, int beginColumn ) {
