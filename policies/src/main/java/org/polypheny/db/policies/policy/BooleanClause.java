...
public class BooleanClause extends Clause {
    ...
    private final Category trueCategory;

    private final Category falseCategory;


    public BooleanClause( String clauseName, boolean defaultValue, Category trueCategory, Category falseCategory ) {
        super( clauseName );
