...
public class DocumentCrud {
    ...
    public List<Result> anyQuery( Session session, QueryRequest request, Crud crud ) {
        ...
        for ( String query : mqls ) {
            ...
            if ( parsed.getFamily() == Family.DDL ) {
                ...
                results.add( getResults( statement, request, signature ) );
            }
    ...
    @NotNull
    private static Result getResults( Statement statement, QueryRequest request, PolyphenyDbSignature<?> signature ) {
