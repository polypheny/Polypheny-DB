...
public class HttpServer implements Runnable {
    ...
    private void attachRoutes( Javalin webuiServer, Crud crud ) {
        ...
        webuiServer.post( "/previewTable", crud::buildPreview );

        webuiServer.get( "/metadataStatus/{uniqueName}", crud::metadataStatus );

        webuiServer.get( "/metadataChange/{uniqueName}", crud::metadataChange );
        ...
        webuiServer.post( "/setMetaConfig", crud::setMetaConfiguration );
