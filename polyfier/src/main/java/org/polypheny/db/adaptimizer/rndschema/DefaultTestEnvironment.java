...
public class DefaultTestEnvironment {
    ...
    public static DataStore generate( Adapter adapter ) {
        ...
        try {
            transaction = AdaptiveOptimizerImpl.getTransactionManager().startTransaction( Catalog.defaultUserId, Catalog.defaultDatabaseId, false, "DefaultTestEnvironment-Adaptimizer" );
        } catch ( Exception e ) {
