...
import org.polypheny.db.adaptimizer.polyfierconnect.PolyfierDQLGenerator;
...
import org.polypheny.db.adaptimizer.polyfierconnect.PolyfierProcess;
...
public abstract class InformationUtil {
    ...
    public static Pair<InformationTable, HashMap<String, InformationPage>>  configureReAdaptiveOptimizerInformation() {
        ...
        addInformationPage( informationManager, informationPages, "polyfier", "Polyfier", "");
        ...
        addInformationElements( informationManager, group, List.of(
                ...
                new InformationAction( group, "Partitioning", parameters -> PolyfierProcess.testAutonomousPartitioning()  ),
                new InformationAction( group, "PolyfierDQLGeneration", parameters -> PolyfierDQLGenerator.testPolyfierDQLGeneration() )
        ) );
