...
public class PolyphenyDbConnectionHandle {
    ...
    private final CatalogNamespace schema;
    ...
    public PolyphenyDbConnectionHandle( final Meta.ConnectionHandle handle, final CatalogUser catalogUser, final ConnectionId connectionId, final CatalogDatabase database, final CatalogNamespace schema, final TransactionManager transactionManager ) {
        this.handle = handle;
    ...
    public PolyphenyDbConnectionHandle( final ConnectionHandle handle, final CatalogUser catalogUser, final String connectionId, final CatalogDatabase database, final CatalogNamespace schema, final TransactionManager transactionManager ) {
        this.handle = handle;
