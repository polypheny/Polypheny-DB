...
public class SqlTest {
    ...
    private void checkSql( String sql, String model, Function<ResultSet, Void> fn ) throws SQLException {
    ...
    public void testSalesEmps() throws SQLException {
        ...
        sql( "sales", sql )
                .returns( "EMPNO=100; NAME=Fred; DEPTNO=30", "EMPNO=110; NAME=Eric; DEPTNO=20", "EMPNO=110; NAME=John; DEPTNO=40", "EMPNO=120; NAME=Wilma; DEPTNO=20", "EMPNO=130; NAME=Alice; DEPTNO=40" )
                .ok();
    }
    ...
    public void testSalesDepts() throws SQLException {
        ...
        sql( "sales", sql )
                .returns( "DEPTNO=10; NAME=Sales", "DEPTNO=20; NAME=Marketing", "DEPTNO=30; NAME=Accounts" )
                .ok();
    }
    ...
    public void testCsvSalesEmpty() throws SQLException {
        ...
        checkSql( sql, "sales-csv", resultSet -> {
            try {
                ...
                assertThat( resultSet.getMetaData().getColumnName( 1 ), is( "EmptyFileHasNoColumns" ) );
    ...
    public void testGroupByTimestampAdd() throws SQLException {
        ...
        sql( "sales-csv", sql )
                .returnsUnordered( "C=1; T=1996-08-04", "C=1; T=2002-05-04", "C=1; T=2005-09-08", "C=1; T=2007-01-02", "C=1; T=2001-01-02" )
                .ok();
        ...
        sql( "sales-csv", sql2 )
                .returnsUnordered( "C=1; T=2002-06-03", "C=1; T=2005-10-07", "C=1; T=2007-02-01", "C=1; T=2001-02-01", "C=1; T=1996-09-03" )
                .ok();
        final String sql3 = "select\n"
                + " distinct {fn timestampadd(SQL_TSI_MONTH, 1, JOINEDAT) } as t\n"
                + "from EMPS";
        sql( "sales-csv", sql3 )
                .returnsUnordered( "T=2002-06-03", "T=2005-10-07", "T=2007-02-01", "T=2001-02-01", "T=1996-09-03" )
                .ok();
    }
