 ...
 */
public class SqlParseException extends Exception implements PolyphenyDbParserException {
     ...
     */
    public SqlParseException( String message, ParserPos pos, int[][] expectedTokenSequences, String[] tokenImages, Throwable parserException ) {
