...
import org.polypheny.db.languages.sql.dialect.AccessSqlDialect;
import org.polypheny.db.languages.sql.dialect.AnsiSqlDialect;
import org.polypheny.db.languages.sql.dialect.BigQuerySqlDialect;
import org.polypheny.db.languages.sql.dialect.Db2SqlDialect;
import org.polypheny.db.languages.sql.dialect.DerbySqlDialect;
import org.polypheny.db.languages.sql.dialect.FirebirdSqlDialect;
import org.polypheny.db.languages.sql.dialect.H2SqlDialect;
import org.polypheny.db.languages.sql.dialect.HiveSqlDialect;
import org.polypheny.db.languages.sql.dialect.HsqldbSqlDialect;
import org.polypheny.db.languages.sql.dialect.InfobrightSqlDialect;
import org.polypheny.db.languages.sql.dialect.InformixSqlDialect;
import org.polypheny.db.languages.sql.dialect.IngresSqlDialect;
import org.polypheny.db.languages.sql.dialect.InterbaseSqlDialect;
import org.polypheny.db.languages.sql.dialect.JethroDataSqlDialect;
import org.polypheny.db.languages.sql.dialect.JethroDataSqlDialect.JethroInfoCache;
import org.polypheny.db.languages.sql.dialect.LucidDbSqlDialect;
import org.polypheny.db.languages.sql.dialect.MssqlSqlDialect;
import org.polypheny.db.languages.sql.dialect.MysqlSqlDialect;
import org.polypheny.db.languages.sql.dialect.NeoviewSqlDialect;
import org.polypheny.db.languages.sql.dialect.NetezzaSqlDialect;
import org.polypheny.db.languages.sql.dialect.OracleSqlDialect;
import org.polypheny.db.languages.sql.dialect.ParaccelSqlDialect;
import org.polypheny.db.languages.sql.dialect.PhoenixSqlDialect;
...
import org.polypheny.db.languages.sql.dialect.RedshiftSqlDialect;
import org.polypheny.db.languages.sql.dialect.SybaseSqlDialect;
import org.polypheny.db.languages.sql.dialect.TeradataSqlDialect;
import org.polypheny.db.languages.sql.dialect.VerticaSqlDialect;
