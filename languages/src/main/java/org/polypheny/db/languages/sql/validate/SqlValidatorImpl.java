...
public class SqlValidatorImpl implements SqlValidatorWithHints {
    ...
    private boolean expandStar( List<SqlNode> selectItems, Set<String> aliases, List<Map.Entry<String, RelDataType>> fields, boolean includeSystemVars, SelectScope scope, SqlNode node ) {
        ...
        switch ( identifier.names.size() ) {
            ...
            default:
                ...
                final NameMatcher nameMatcher = scope.validator.catalogReader.nameMatcher();
    ...
    protected SqlNode performUnconditionalRewrites( SqlNode node, boolean underFrom ) {
        ...
        if ( node instanceof SqlCall ) {
            ...
            for ( int i = 0, count = list.size(); i < count; i++ ) {
                ...
                if ( newOperand != null ) {
                    list.getSqlList().set( i, newOperand );
                }
            }
        }
    ...
    public boolean isAggregate( SqlSelect select ) {
        ...
        for ( SqlCall call : overFinder.findAll( select.getSelectList().getSqlList() ) ) {
