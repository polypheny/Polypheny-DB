...
public abstract class SqlOperatorBaseTest extends LanguageManagerDependant {
    ...
    public void testBetween() {
        tester.setFor( StdOperatorRegistry.get( "BETWEEN" ), SqlTester.VmName.EXPAND );
    ...
    public void testNotBetween() {
        tester.setFor( StdOperatorRegistry.get( "NOT_BETWEEN" ), VM_EXPAND );
    ...
    public void testCastToString() {
        tester.setFor( StdOperatorRegistry.get( "CAST" ) );
    ...
    public void testCase() {
        tester.setFor( StdOperatorRegistry.get( "CASE" ) );
    ...
    public void testLiteralChain() {
        tester.setFor( StdOperatorRegistry.get( "LITERAL_CHAIN" ), VM_EXPAND );
        tester.checkString(
                "'buttered'\n' toast'",
                "buttered toast",
                "CHAR(14) NOT NULL" );
    ...
    @Test
    public void testRow() {
        tester.setFor( StdOperatorRegistry.get( "ROW" ), VM_FENNEL );
    }


    @Test
    public void testAndOperator() {
        tester.setFor( StdOperatorRegistry.get( "AND" ) );
    ...
    public void testConcatOperator() {
        tester.setFor( StdOperatorRegistry.get( "CONCAT" ) );
    ...
    public void testModOperator() {
        ...
        tester1.setFor( StdOperatorRegistry.get( "PERCENT_REMAINDER" ) );
    ...
    public void testDivideOperator() {
        tester.setFor( StdOperatorRegistry.get( "DIVIDE" ) );
    ...
    public void testEqualsOperator() {
        tester.setFor( StdOperatorRegistry.get( "EQUALS" ) );
    ...
    public void testGreaterThanOperator() {
        tester.setFor( StdOperatorRegistry.get( "GREATER_THAN" ) );
    ...
    public void testIsDistinctFromOperator() {
        tester.setFor( StdOperatorRegistry.get( "IS_DISTINCT_FROM" ), VM_EXPAND );
    ...
    public void testIsNotDistinctFromOperator() {
        tester.setFor( StdOperatorRegistry.get( "IS_NOT_DISTINCT_FROM" ), VM_EXPAND );
    ...
    public void testGreaterThanOrEqualOperator() {
        tester.setFor( StdOperatorRegistry.get( "GREATER_THAN_OR_EQUAL" ) );
        tester.checkBoolean( "1>=2", Boolean.FALSE );
    ...
    public void testInOperator() {
        tester.setFor( StdOperatorRegistry.get( "IN" ), VM_EXPAND );
    ...
    public void testNotInOperator() {
        tester.setFor( StdOperatorRegistry.get( "NOT_IN" ), VM_EXPAND );
    ...
    public void testOverlapsOperator() {
        tester.setFor( StdOperatorRegistry.get( "OVERLAPS" ), VM_EXPAND );
    ...
    public void testLessThanOperator() {
        tester.setFor( StdOperatorRegistry.get( "LESS_THAN" ) );
    ...
    public void testLessThanOrEqualOperator() {
        tester.setFor( StdOperatorRegistry.get( "LESS_THAN_OR_EQUAL" ) );
        tester.checkBoolean( "1<=2", Boolean.TRUE );
        tester.checkBoolean( "1<=1", Boolean.TRUE );
        tester.checkBoolean( "-1<=1", Boolean.TRUE );
        tester.checkBoolean( "2<=1", Boolean.FALSE );
    ...
    public void testMinusOperator() {
        tester.setFor( StdOperatorRegistry.get( "MINUS" ) );
    ...
    public void testMinusDateOperator() {
        tester.setFor( StdOperatorRegistry.get( "MINUS_DATE" ) );
        tester.checkScalar(
    ...
    public void testMultiplyOperator() {
        tester.setFor( StdOperatorRegistry.get( "MULTIPLY" ) );
    ...
    public void testNotEqualsOperator() {
        tester.setFor( StdOperatorRegistry.get( "NOT_EQUALS" ) );
        tester.checkBoolean( "1<>1", Boolean.FALSE );
    ...
    public void testOrOperator() {
        tester.setFor( StdOperatorRegistry.get( "OR" ) );
    ...
    public void testPlusOperator() {
        tester.setFor( StdOperatorRegistry.get( "PLUS" ) );
    ...
    public void testDescendingOperator() {
        tester.setFor( StdOperatorRegistry.get( "DESC" ), VM_EXPAND );
    }


    @Test
    public void testIsNotNullOperator() {
        tester.setFor( StdOperatorRegistry.get( "IS_NOT_NULL" ) );
    ...
    public void testIsNullOperator() {
        tester.setFor( StdOperatorRegistry.get( "IS_NULL" ) );
    ...
    public void testIsNotTrueOperator() {
        tester.setFor( StdOperatorRegistry.get( "IS_NOT_TRUE" ) );
    ...
    public void testIsTrueOperator() {
        tester.setFor( StdOperatorRegistry.get( "IS_TRUE" ) );
    ...
    public void testIsNotFalseOperator() {
        tester.setFor( StdOperatorRegistry.get( "IS_NOT_FALSE" ) );
    ...
    public void testIsFalseOperator() {
        tester.setFor( StdOperatorRegistry.get( "IS_FALSE" ) );
    ...
    public void testIsNotUnknownOperator() {
        tester.setFor( StdOperatorRegistry.get( "IS_NOT_UNKNOWN" ), VM_EXPAND );
    ...
    public void testIsUnknownOperator() {
        tester.setFor( StdOperatorRegistry.get( "IS_UNKNOWN" ), VM_EXPAND );
    ...
    public void testIsASetOperator() {
        tester.setFor( StdOperatorRegistry.get( "IS_A_SET" ), VM_EXPAND );
    ...
    public void testIsNotASetOperator() {
        tester.setFor( StdOperatorRegistry.get( "IS_NOT_A_SET" ), VM_EXPAND );
    ...
    public void testIntersectOperator() {
        tester.setFor( StdOperatorRegistry.get( "MULTISET_INTERSECT" ), VM_EXPAND );
        tester.checkScalar(
    ...
    public void testExceptOperator() {
        tester.setFor( StdOperatorRegistry.get( "MULTISET_EXCEPT" ), VM_EXPAND );
        tester.checkScalar(
    ...
    public void testIsEmptyOperator() {
        tester.setFor( StdOperatorRegistry.get( "IS_EMPTY" ), VM_EXPAND );
    ...
    public void testIsNotEmptyOperator() {
        tester.setFor( StdOperatorRegistry.get( "IS_NOT_EMPTY" ), VM_EXPAND );
    ...
    public void testExistsOperator() {
        tester.setFor( StdOperatorRegistry.get( "EXISTS" ), VM_EXPAND );
    }


    @Test
    public void testNotOperator() {
        tester.setFor( StdOperatorRegistry.get( "NOT" ) );
    ...
    public void testPrefixMinusOperator() {
        tester.setFor( StdOperatorRegistry.get( "UNARY_MINUS" ) );
        tester.checkFails(
                "'a' + ^- 'b'^ + 'c'",
    ...
    public void testPrefixPlusOperator() {
        tester.setFor( StdOperatorRegistry.get( "UNARY_PLUS" ), VM_EXPAND );
        tester.checkScalarExact( "+1", "1" );
    ...
    public void testExplicitTableOperator() {
        tester.setFor( StdOperatorRegistry.get( "EXPLICIT_TABLE" ), VM_EXPAND );
    }


    @Test
    public void testValuesOperator() {
        tester.setFor( StdOperatorRegistry.get( "VALUES" ), VM_EXPAND );
        tester.check(
    ...
    public void testNotLikeOperator() {
        tester.setFor( StdOperatorRegistry.get( "NOT_LIKE" ), VM_EXPAND );
    ...
    public void testLikeEscape() {
        tester.setFor( StdOperatorRegistry.get( "LIKE" ) );
    ...
    public void testNotSimilarToOperator() {
        tester.setFor( StdOperatorRegistry.get( "NOT_SIMILAR_TO" ), VM_EXPAND );
    ...
    public void testSimilarToOperator() {
        tester.setFor( StdOperatorRegistry.get( "SIMILAR_TO" ) );
    ...
    public void testEscapeOperator() {
        tester.setFor( StdOperatorRegistry.get( "ESCAPE" ), VM_EXPAND );
    }


    @Test
    public void testConvertFunc() {
        tester.setFor( StdOperatorRegistry.get( "CONVERT" ), VM_FENNEL, VM_JAVA );
    }


    @Test
    public void testTranslateFunc() {
        tester.setFor( StdOperatorRegistry.get( "TRANSLATE" ), VM_FENNEL, VM_JAVA );
    }
    ...
    */
    ...
    public void testOverlayFunc() {
        tester.setFor( StdOperatorRegistry.get( "OVERLAY" ) );
        tester.checkString(
    ...
    public void testPositionFunc() {
        tester.setFor( StdOperatorRegistry.get( "POSITION" ) );
    ...
    public void testReplaceFunc() {
        tester.setFor( StdOperatorRegistry.get( "REPLACE" ) );
    ...
    public void testCharLengthFunc() {
        tester.setFor( StdOperatorRegistry.get( "CHAR_LENGTH" ) );
    ...
    public void testCharacterLengthFunc() {
        tester.setFor( StdOperatorRegistry.get( "CHARACTER_LENGTH" ) );
    ...
    public void testUpperFunc() {
        tester.setFor( StdOperatorRegistry.get( "UPPER" ) );
    ...
    public void testLowerFunc() {
        tester.setFor( StdOperatorRegistry.get( "LOWER" ) );
    ...
    public void testInitcapFunc() {
        ...
        tester.setFor( StdOperatorRegistry.get( "INITCAP" ), VM_FENNEL );
    ...
    public void testPowerFunc() {
        tester.setFor( StdOperatorRegistry.get( "POWER" ) );
        tester.checkScalarApprox(
                "power(2,-2)",
                "DOUBLE NOT NULL",
                0.25,
    ...
    public void testSqrtFunc() {
        tester.setFor( StdOperatorRegistry.get( "SQRT" ), SqlTester.VmName.EXPAND );
    ...
    public void testExpFunc() {
        tester.setFor( StdOperatorRegistry.get( "EXP" ), VM_FENNEL );
    ...
    public void testModFunc() {
        tester.setFor( StdOperatorRegistry.get( "MOD" ) );
    ...
    public void testLnFunc() {
        tester.setFor( StdOperatorRegistry.get( "LN" ) );
        tester.checkScalarApprox(
                "ln(2.71828)",
                "DOUBLE NOT NULL",
                1.0,
    ...
    public void testLogFunc() {
        tester.setFor( StdOperatorRegistry.get( "LOG10" ) );
        tester.checkScalarApprox(
                "log10(10)",
                "DOUBLE NOT NULL",
                1.0,
    ...
    public void testRandFunc() {
        tester.setFor( StdOperatorRegistry.get( "RAND" ) );
    ...
    public void testRandIntegerFunc() {
        tester.setFor( StdOperatorRegistry.get( "RAND_INTEGER" ) );
        for ( int i = 0; i < 100; i++ ) {
    ...
    public void testAbsFunc() {
        tester.setFor( StdOperatorRegistry.get( "ABS" ) );
    ...
    public void testAcosFunc() {
        tester.setFor( StdOperatorRegistry.get( "ACOS" ) );
    ...
    public void testAsinFunc() {
        tester.setFor( StdOperatorRegistry.get( "ASIN" ) );
    ...
    public void testAtanFunc() {
        tester.setFor( StdOperatorRegistry.get( "ATAN" ) );
    ...
    public void testAtan2Func() {
        tester.setFor( StdOperatorRegistry.get( "ATAN2" ) );
    ...
    public void testCosFunc() {
        tester.setFor( StdOperatorRegistry.get( "COS" ) );
    ...
    public void testCotFunc() {
        tester.setFor( StdOperatorRegistry.get( "COT" ) );
    ...
    public void testDegreesFunc() {
        tester.setFor( StdOperatorRegistry.get( "DEGREES" ) );
    ...
    public void testPiFunc() {
        tester.setFor( StdOperatorRegistry.get( "PI" ) );
    ...
    public void testRadiansFunc() {
        tester.setFor( StdOperatorRegistry.get( "RADIANS" ) );
    ...
    public void testRoundFunc() {
        tester.setFor( StdOperatorRegistry.get( "ROUND" ) );
    ...
    public void testSignFunc() {
        tester.setFor( StdOperatorRegistry.get( "SIGN" ) );
    ...
    public void testSinFunc() {
        tester.setFor( StdOperatorRegistry.get( "SIN" ) );
    ...
    public void testTanFunc() {
        tester.setFor( StdOperatorRegistry.get( "TAN" ) );
    ...
    public void testTruncateFunc() {
        tester.setFor( StdOperatorRegistry.get( "TRUNCATE" ) );
    ...
    public void testNullifFunc() {
        tester.setFor( StdOperatorRegistry.get( "NULLIF" ), VM_EXPAND );
    ...
    public void testCoalesceFunc() {
        tester.setFor( StdOperatorRegistry.get( "COALESCE" ), VM_EXPAND );
    ...
    public void testUserFunc() {
        tester.setFor( StdOperatorRegistry.get( "USER" ), VM_FENNEL );
    ...
    public void testCurrentUserFunc() {
        tester.setFor( StdOperatorRegistry.get( "CURRENT_USER" ), VM_FENNEL );
    ...
    public void testSessionUserFunc() {
        tester.setFor( StdOperatorRegistry.get( "SESSION_USER" ), VM_FENNEL );
    ...
    public void testSystemUserFunc() {
        tester.setFor( StdOperatorRegistry.get( "SYSTEM_USER" ), VM_FENNEL );
    ...
    public void testCurrentPathFunc() {
        tester.setFor( StdOperatorRegistry.get( "CURRENT_PATH" ), VM_FENNEL );
    ...
    public void testCurrentRoleFunc() {
        tester.setFor( StdOperatorRegistry.get( "CURRENT_ROLE" ), VM_FENNEL );
    ...
    public void testCurrentCatalogFunc() {
        tester.setFor( StdOperatorRegistry.get( "CURRENT_CATALOG" ), VM_FENNEL );
    ...
    public void testLocalTimeFunc() {
        tester.setFor( StdOperatorRegistry.get( "LOCALTIME" ) );
    ...
    public void testLocalTimestampFunc() {
        tester.setFor( StdOperatorRegistry.get( "LOCALTIMESTAMP" ) );
        tester.checkScalar(
                "LOCALTIMESTAMP",
                TIMESTAMP_PATTERN,
                "TIMESTAMP(0) NOT NULL" );
    ...
    public void testCurrentTimeFunc() {
        tester.setFor( StdOperatorRegistry.get( "CURRENT_TIME" ) );
        tester.checkScalar(
    ...
    public void testCurrentTimestampFunc() {
        tester.setFor( StdOperatorRegistry.get( "CURRENT_TIMESTAMP" ) );
        tester.checkScalar(
                "CURRENT_TIMESTAMP",
                TIMESTAMP_PATTERN,
                "TIMESTAMP(0) NOT NULL" );
    ...
    public void testCurrentDateFunc() {
        tester.setFor( StdOperatorRegistry.get( "CURRENT_DATE" ), VM_FENNEL );
    ...
    public void testSubstringFunction() {
        tester.setFor( StdOperatorRegistry.get( "SUBSTRING" ) );
        tester.checkString(
    ...
    public void testTrimFunc() {
        tester.setFor( StdOperatorRegistry.get( "TRIM" ) );
    ...
    */
    ...
    public void testElementFunc() {
        tester.setFor( StdOperatorRegistry.get( "ELEMENT" ), VM_FENNEL, VM_JAVA );
    ...
    public void testCardinalityFunc() {
        tester.setFor( StdOperatorRegistry.get( "CARDINALITY" ), VM_FENNEL, VM_JAVA );
    ...
    public void testMemberOfOperator() {
        tester.setFor( StdOperatorRegistry.get( "MEMBER_OF" ), VM_FENNEL, VM_JAVA );
    ...
    public void testMultisetUnionOperator() {
        tester.setFor( StdOperatorRegistry.get( "MULTISET_UNION_DISTINCT" ), VM_FENNEL, VM_JAVA );
    ...
    public void testMultisetUnionAllOperator() {
        tester.setFor( StdOperatorRegistry.get( "MULTISET_UNION" ), VM_FENNEL, VM_JAVA );
        tester.checkScalar(
    ...
    public void testSubMultisetOfOperator() {
        tester.setFor( StdOperatorRegistry.get( "SUBMULTISET_OF" ), VM_FENNEL, VM_JAVA );
    ...
    public void testNotSubMultisetOfOperator() {
        tester.setFor( StdOperatorRegistry.get( "NOT_SUBMULTISET_OF" ), VM_FENNEL, VM_JAVA );
    ...
    public void testCollectFunc() {
        tester.setFor( StdOperatorRegistry.get( "COLLECT" ), VM_FENNEL, VM_JAVA );
    ...
    public void testFusionFunc() {
        tester.setFor( StdOperatorRegistry.get( "FUSION" ), VM_FENNEL, VM_JAVA );
    }


    @Test
    public void testYear() {
        tester.setFor( StdOperatorRegistry.get( "YEAR" ), VM_FENNEL, VM_JAVA );
    ...
    public void testQuarter() {
        tester.setFor( StdOperatorRegistry.get( "QUARTER" ), VM_FENNEL, VM_JAVA );
    ...
    public void testMonth() {
        tester.setFor( StdOperatorRegistry.get( "MONTH" ), VM_FENNEL, VM_JAVA );
    ...
    public void testWeek() {
        tester.setFor( StdOperatorRegistry.get( "WEEK" ), VM_FENNEL, VM_JAVA );
        if ( Bug.CALCITE_2539_FIXED ) {
    ...
    public void testDayOfYear() {
        tester.setFor( StdOperatorRegistry.get( "DAYOFYEAR" ), VM_FENNEL, VM_JAVA );
        if ( Bug.CALCITE_2539_FIXED ) {
            // TODO: Not implemented in operator test execution code
            tester.checkFails(
    ...
    public void testDayOfMonth() {
        tester.setFor( StdOperatorRegistry.get( "DAYOFMONTH" ), VM_FENNEL, VM_JAVA );
        tester.checkScalar(
    ...
    public void testDayOfWeek() {
        tester.setFor( StdOperatorRegistry.get( "DAYOFWEEK" ), VM_FENNEL, VM_JAVA );
        if ( Bug.CALCITE_2539_FIXED ) {
            // TODO: Not implemented in operator test execution code
            tester.checkFails(
    ...
    public void testHour() {
        tester.setFor( StdOperatorRegistry.get( "HOUR" ), VM_FENNEL, VM_JAVA );
    ...
    public void testMinute() {
        tester.setFor( StdOperatorRegistry.get( "MINUTE" ), VM_FENNEL, VM_JAVA );
    ...
    public void testSecond() {
        tester.setFor( StdOperatorRegistry.get( "SECOND" ), VM_FENNEL, VM_JAVA );
    ...
    public void testExtractIntervalYearMonth() {
        tester.setFor( StdOperatorRegistry.get( "EXTRACT" ), VM_FENNEL, VM_JAVA );
    ...
    public void testExtractFunc() {
        tester.setFor(
                StdOperatorRegistry.get( "EXTRACT" ),
                VM_FENNEL,
                VM_JAVA );
    ...
    public void testArrayValueConstructor() {
        tester.setFor( StdOperatorRegistry.get( "ARRAY_VALUE_CONSTRUCTOR" ) );
        tester.checkScalar(
                "Array['foo', 'bar']",
                "[foo, bar]",
    ...
    public void testItemOp() {
        tester.setFor( StdOperatorRegistry.get( "ITEM" ) );
    ...
    public void testMapValueConstructor() {
        tester.setFor( StdOperatorRegistry.get( "MAP_VALUE_CONSTRUCTOR" ), VM_JAVA );
    ...
    public void testCeilFunc() {
        tester.setFor( StdOperatorRegistry.get( "CEIL" ), VM_FENNEL );
    ...
    public void testFloorFunc() {
        tester.setFor( StdOperatorRegistry.get( "FLOOR" ), VM_FENNEL );
    ...
    public void testTimestampAdd() {
        tester.setFor( StdOperatorRegistry.get( "TIMESTAMP_ADD" ) );
        tester.checkScalar(
    ...
    public void testTimestampDiff() {
        tester.setFor( StdOperatorRegistry.get( "TIMESTAMP_DIFF" ) );
        tester.checkScalar(
    ...
    public void testDenseRankFunc() {
        tester.setFor( StdOperatorRegistry.get( "DENSE_RANK" ), VM_FENNEL, VM_JAVA );
    }


    @Test
    public void testPercentRankFunc() {
        tester.setFor( StdOperatorRegistry.get( "PERCENT_RANK" ), VM_FENNEL, VM_JAVA );
    }


    @Test
    public void testRankFunc() {
        tester.setFor( StdOperatorRegistry.get( "RANK" ), VM_FENNEL, VM_JAVA );
    }


    @Test
    public void testCumeDistFunc() {
        tester.setFor( StdOperatorRegistry.get( "CUME_DIST" ), VM_FENNEL, VM_JAVA );
    }


    @Test
    public void testRowNumberFunc() {
        tester.setFor( StdOperatorRegistry.get( "ROW_NUMBER" ), VM_FENNEL, VM_JAVA );
    }


    @Test
    public void testCountFunc() {
        tester.setFor( StdOperatorRegistry.get( "COUNT" ), VM_EXPAND );
    ...
    public void testSumFunc() {
        tester.setFor( StdOperatorRegistry.get( "SUM" ), VM_EXPAND );
        tester.checkFails(
                "sum(^*^)",
                "Unknown identifier '\\*'",
                false );
    ...
    public void testAvgFunc() {
        tester.setFor( StdOperatorRegistry.get( "AVG" ), VM_EXPAND );
        tester.checkFails(
                "avg(^*^)",
                "Unknown identifier '\\*'",
                false );
    ...
    public void testCovarPopFunc() {
        tester.setFor( StdOperatorRegistry.get( "COVAR_POP" ), VM_EXPAND );
    ...
    public void testCovarSampFunc() {
        tester.setFor( StdOperatorRegistry.get( "COVAR_SAMP" ), VM_EXPAND );
        tester.checkFails(
                "covar_samp(^*^)",
                "Unknown identifier '\\*'",
                false );
    ...
    public void testRegrSxxFunc() {
        tester.setFor( StdOperatorRegistry.get( "REGR_SXX" ), VM_EXPAND );
        tester.checkFails(
                "regr_sxx(^*^)",
                "Unknown identifier '\\*'",
                false );
    ...
    public void testRegrSyyFunc() {
        tester.setFor( StdOperatorRegistry.get( "REGR_SYY" ), VM_EXPAND );
        tester.checkFails(
                "regr_syy(^*^)",
                "Unknown identifier '\\*'",
                false );
    ...
    public void testStddevPopFunc() {
        tester.setFor( StdOperatorRegistry.get( "STDDEV_POP" ), VM_EXPAND );
        tester.checkFails(
                "stddev_pop(^*^)",
                "Unknown identifier '\\*'",
                false );
    ...
    public void testStddevSampFunc() {
        tester.setFor( StdOperatorRegistry.get( "STDDEV_SAMP" ), VM_EXPAND );
        tester.checkFails(
                "stddev_samp(^*^)",
                "Unknown identifier '\\*'",
                false );
    ...
    public void testStddevFunc() {
        tester.setFor( StdOperatorRegistry.get( "STDDEV" ), VM_EXPAND );
        tester.checkFails(
                "stddev(^*^)",
                "Unknown identifier '\\*'",
                false );
    ...
    public void testVarPopFunc() {
        tester.setFor( StdOperatorRegistry.get( "VAR_POP" ), VM_EXPAND );
        tester.checkFails(
                "var_pop(^*^)",
                "Unknown identifier '\\*'",
                false );
    ...
    public void testVarSampFunc() {
        tester.setFor( StdOperatorRegistry.get( "VAR_SAMP" ), VM_EXPAND );
        tester.checkFails(
                "var_samp(^*^)",
                "Unknown identifier '\\*'",
                false );
    ...
    public void testVarFunc() {
        tester.setFor( StdOperatorRegistry.get( "VARIANCE" ), VM_EXPAND );
        tester.checkFails(
                "variance(^*^)",
                "Unknown identifier '\\*'",
                false );
    ...
    public void testMinFunc() {
        tester.setFor( StdOperatorRegistry.get( "MIN" ), VM_EXPAND );
        tester.checkFails(
                "min(^*^)",
                "Unknown identifier '\\*'",
                false );
    ...
    public void testMaxFunc() {
        tester.setFor( StdOperatorRegistry.get( "MAX" ), VM_EXPAND );
        tester.checkFails(
                "max(^*^)",
                "Unknown identifier '\\*'",
                false );
    ...
    public void testLastValueFunc() {
        tester.setFor( StdOperatorRegistry.get( "LAST_VALUE" ), VM_EXPAND );
    ...
    public void testFirstValueFunc() {
        tester.setFor( StdOperatorRegistry.get( "FIRST_VALUE" ), VM_EXPAND );
        final String[] values = { "0", "CAST(null AS INTEGER)", "3", "3" };
        if ( !enable ) {
            return;
        }
    ...
    public void testAnyValueFunc() {
        tester.setFor( StdOperatorRegistry.get( "ANY_VALUE" ), VM_EXPAND );
        tester.checkFails(
                "any_value(^*^)",
                "Unknown identifier '\\*'",
                false );
    ...
    public void testBitAndFunc() {
        tester.setFor( StdOperatorRegistry.get( "BIT_AND" ), VM_FENNEL, VM_JAVA );
    ...
    public void testBitOrFunc() {
        tester.setFor( StdOperatorRegistry.get( "BIT_OR" ), VM_FENNEL, VM_JAVA );
