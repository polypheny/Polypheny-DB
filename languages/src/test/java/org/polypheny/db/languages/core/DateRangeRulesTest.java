 ...
 */
public class DateRangeRulesTest extends LanguageManagerDependant {
    ...
    public void testExtractYearFromDateColumn() {
        ...
        checkDateRange( f, f.eq( f.exYearD, f.literal( 2014 ) ), is( "AND(>=($8, 2014-01-01), <($8, 2015-01-01))" ) );
        checkDateRange( f, f.ge( f.exYearD, f.literal( 2014 ) ), is( ">=($8, 2014-01-01)" ) );
        checkDateRange( f, f.gt( f.exYearD, f.literal( 2014 ) ), is( ">=($8, 2015-01-01)" ) );
        checkDateRange( f, f.lt( f.exYearD, f.literal( 2014 ) ), is( "<($8, 2014-01-01)" ) );
        checkDateRange( f, f.le( f.exYearD, f.literal( 2014 ) ), is( "<($8, 2015-01-01)" ) );
        checkDateRange( f, f.ne( f.exYearD, f.literal( 2014 ) ), is( "<>(EXTRACT(FLAG(YEAR), $8), 2014)" ) );
    }
    ...
    public void testExtractYearFromTimestampColumn() {
        final Fixture2 f = new Fixture2();
        checkDateRange( f, f.eq( f.exYearTs, f.literal( 2014 ) ), is( "AND(>=($9, 2014-01-01 00:00:00), <($9, 2015-01-01 00:00:00))" ) );
        checkDateRange( f, f.ge( f.exYearTs, f.literal( 2014 ) ), is( ">=($9, 2014-01-01 00:00:00)" ) );
        checkDateRange( f, f.gt( f.exYearTs, f.literal( 2014 ) ), is( ">=($9, 2015-01-01 00:00:00)" ) );
        checkDateRange( f, f.lt( f.exYearTs, f.literal( 2014 ) ), is( "<($9, 2014-01-01 00:00:00)" ) );
        checkDateRange( f, f.le( f.exYearTs, f.literal( 2014 ) ), is( "<($9, 2015-01-01 00:00:00)" ) );
    ...
    public void testExtractYearAndMonthFromDateColumn2() {
        ...
        final String s2 = "AND(>=($8, 2000-01-01), <($8, 2001-01-01),"
                ...
                + "AND(>=($8, 2000-05-01), <($8, 2000-06-01)))"
                + ")";
        final RexNode e = f.and( f.eq( f.exYearD, f.literal( 2000 ) ), f.or( f.eq( f.exMonthD, f.literal( 2 ) ), f.eq( f.exMonthD, f.literal( 3 ) ), f.eq( f.exMonthD, f.literal( 5 ) ) ) );
    ...
    public void testExtractRewriteMultipleOperands() {
        ...
        checkDateRange( f,
                ...
                is( "AND(AND(>=($9, 2010-01-01 00:00:00), <($9, 2011-01-01 00:00:00)),"
                        + " AND(>=($9, 2010-10-01 00:00:00), <($9, 2010-11-01 00:00:00)),"
                        + " AND(>=($8, 2011-01-01), <($8, 2012-01-01)),"
                        + " AND(>=($8, 2011-05-01), <($8, 2011-06-01)))" ) );
    }
    ...
    public void testFloorEqRewrite() {
        ...
        checkDateRange( f, f.eq( f.timestampLiteral( TimestampString.fromCalendarFields( c ) ), f.floorYear ), is( "false" ) );

        c.clear();
        c.set( 2010, Calendar.JANUARY, 1, 0, 0, 0 );
        checkDateRange( f, f.eq( f.floorYear, f.timestampLiteral( TimestampString.fromCalendarFields( c ) ) ), is( "AND(>=($9, 2010-01-01 00:00:00), <($9, 2011-01-01 00:00:00))" ) );

        c.set( 2010, Calendar.FEBRUARY, 1, 0, 0, 0 );
        checkDateRange( f, f.eq( f.floorMonth, f.timestampLiteral( TimestampString.fromCalendarFields( c ) ) ), is( "AND(>=($9, 2010-02-01 00:00:00), <($9, 2010-03-01 00:00:00))" ) );

        c.set( 2010, Calendar.DECEMBER, 1, 0, 0, 0 );
        checkDateRange( f, f.eq( f.floorMonth, f.timestampLiteral( TimestampString.fromCalendarFields( c ) ) ), is( "AND(>=($9, 2010-12-01 00:00:00), <($9, 2011-01-01 00:00:00))" ) );

        c.set( 2010, Calendar.FEBRUARY, 4, 0, 0, 0 );
        checkDateRange( f, f.eq( f.floorDay, f.timestampLiteral( TimestampString.fromCalendarFields( c ) ) ), is( "AND(>=($9, 2010-02-04 00:00:00), <($9, 2010-02-05 00:00:00))" ) );

        c.set( 2010, Calendar.DECEMBER, 31, 0, 0, 0 );
        checkDateRange( f, f.eq( f.floorDay, f.timestampLiteral( TimestampString.fromCalendarFields( c ) ) ), is( "AND(>=($9, 2010-12-31 00:00:00), <($9, 2011-01-01 00:00:00))" ) );

        c.set( 2010, Calendar.FEBRUARY, 4, 4, 0, 0 );
        checkDateRange( f, f.eq( f.floorHour, f.timestampLiteral( TimestampString.fromCalendarFields( c ) ) ), is( "AND(>=($9, 2010-02-04 04:00:00), <($9, 2010-02-04 05:00:00))" ) );

        c.set( 2010, Calendar.DECEMBER, 31, 23, 0, 0 );
        checkDateRange( f, f.eq( f.floorHour, f.timestampLiteral( TimestampString.fromCalendarFields( c ) ) ), is( "AND(>=($9, 2010-12-31 23:00:00), <($9, 2011-01-01 00:00:00))" ) );

        c.set( 2010, Calendar.FEBRUARY, 4, 2, 32, 0 );
        checkDateRange( f, f.eq( f.floorMinute, f.timestampLiteral( TimestampString.fromCalendarFields( c ) ) ), is( "AND(>=($9, 2010-02-04 02:32:00), <($9, 2010-02-04 02:33:00))" ) );

        c.set( 2010, Calendar.FEBRUARY, 4, 2, 59, 0 );
        checkDateRange( f, f.eq( f.floorMinute, f.timestampLiteral( TimestampString.fromCalendarFields( c ) ) ), is( "AND(>=($9, 2010-02-04 02:59:00), <($9, 2010-02-04 03:00:00))" ) );
    }
    ...
    public void testFloorLtRewrite() {
        ...
        c.clear();
        c.set( 2010, Calendar.JANUARY, 1, 0, 0, 0 );
        checkDateRange( f, f.lt( f.floorYear, f.timestampLiteral( TimestampString.fromCalendarFields( c ) ) ), is( "<($9, 2010-01-01 00:00:00)" ) );
    }
    ...
    public void testFloorGeRewrite() {
        ...
        c.clear();
        c.set( 2010, Calendar.JANUARY, 1, 0, 0, 0 );
        checkDateRange( f, f.ge( f.floorYear, f.timestampLiteral( TimestampString.fromCalendarFields( c ) ) ), is( ">=($9, 2010-01-01 00:00:00)" ) );
    }
    ...
    public void testCeilEqRewrite() {
        ...
        checkDateRange( f, f.eq( f.timestampLiteral( TimestampString.fromCalendarFields( c ) ), f.ceilYear ), is( "false" ) );

        c.clear();
        c.set( 2010, Calendar.JANUARY, 1, 0, 0, 0 );
        checkDateRange( f, f.eq( f.ceilYear, f.timestampLiteral( TimestampString.fromCalendarFields( c ) ) ), is( "AND(>($9, 2009-01-01 00:00:00), <=($9, 2010-01-01 00:00:00))" ) );

        c.set( 2010, Calendar.FEBRUARY, 1, 0, 0, 0 );
        checkDateRange( f, f.eq( f.ceilMonth, f.timestampLiteral( TimestampString.fromCalendarFields( c ) ) ), is( "AND(>($9, 2010-01-01 00:00:00), <=($9, 2010-02-01 00:00:00))" ) );

        c.set( 2010, Calendar.DECEMBER, 1, 0, 0, 0 );
        checkDateRange( f, f.eq( f.ceilMonth, f.timestampLiteral( TimestampString.fromCalendarFields( c ) ) ), is( "AND(>($9, 2010-11-01 00:00:00), <=($9, 2010-12-01 00:00:00))" ) );

        c.set( 2010, Calendar.FEBRUARY, 4, 0, 0, 0 );
        checkDateRange( f, f.eq( f.ceilDay, f.timestampLiteral( TimestampString.fromCalendarFields( c ) ) ), is( "AND(>($9, 2010-02-03 00:00:00), <=($9, 2010-02-04 00:00:00))" ) );

        c.set( 2010, Calendar.DECEMBER, 31, 0, 0, 0 );
        checkDateRange( f, f.eq( f.ceilDay, f.timestampLiteral( TimestampString.fromCalendarFields( c ) ) ), is( "AND(>($9, 2010-12-30 00:00:00), <=($9, 2010-12-31 00:00:00))" ) );

        c.set( 2010, Calendar.FEBRUARY, 4, 4, 0, 0 );
        checkDateRange( f, f.eq( f.ceilHour, f.timestampLiteral( TimestampString.fromCalendarFields( c ) ) ), is( "AND(>($9, 2010-02-04 03:00:00), <=($9, 2010-02-04 04:00:00))" ) );

        c.set( 2010, Calendar.DECEMBER, 31, 23, 0, 0 );
        checkDateRange( f, f.eq( f.ceilHour, f.timestampLiteral( TimestampString.fromCalendarFields( c ) ) ), is( "AND(>($9, 2010-12-31 22:00:00), <=($9, 2010-12-31 23:00:00))" ) );

        c.set( 2010, Calendar.FEBRUARY, 4, 2, 32, 0 );
        checkDateRange( f, f.eq( f.ceilMinute, f.timestampLiteral( TimestampString.fromCalendarFields( c ) ) ), is( "AND(>($9, 2010-02-04 02:31:00), <=($9, 2010-02-04 02:32:00))" ) );

        c.set( 2010, Calendar.FEBRUARY, 4, 2, 59, 0 );
        checkDateRange( f, f.eq( f.ceilMinute, f.timestampLiteral( TimestampString.fromCalendarFields( c ) ) ), is( "AND(>($9, 2010-02-04 02:58:00), <=($9, 2010-02-04 02:59:00))" ) );
    }
    ...
    public void testCeilLtRewrite() {
        ...
        c.clear();
        c.set( 2010, Calendar.JANUARY, 1, 0, 0, 0 );
        checkDateRange( f, f.lt( f.ceilYear, f.timestampLiteral( TimestampString.fromCalendarFields( c ) ) ), is( "<=($9, 2009-01-01 00:00:00)" ) );
    }
    ...
    public void testCeilGeRewrite() {
        ...
        c.clear();
        c.set( 2010, Calendar.JANUARY, 1, 0, 0, 0 );
        checkDateRange( f, f.ge( f.ceilYear, f.timestampLiteral( TimestampString.fromCalendarFields( c ) ) ), is( ">($9, 2009-01-01 00:00:00)" ) );
    }
    ...
    private static class Fixture2 extends TestFixture {
        ...
        Fixture2() {
            exYearTs = rexBuilder.makeCall( OperatorRegistry.get( OperatorName.EXTRACT ), ImmutableList.of( rexBuilder.makeFlag( TimeUnitRange.YEAR ), ts ) );
            exMonthTs = rexBuilder.makeCall( intAlgDataType, OperatorRegistry.get( OperatorName.EXTRACT ), ImmutableList.of( rexBuilder.makeFlag( TimeUnitRange.MONTH ), ts ) );
            exDayTs = rexBuilder.makeCall( intAlgDataType, OperatorRegistry.get( OperatorName.EXTRACT ), ImmutableList.of( rexBuilder.makeFlag( TimeUnitRange.DAY ), ts ) );
            exYearD = rexBuilder.makeCall( OperatorRegistry.get( OperatorName.EXTRACT ), ImmutableList.of( rexBuilder.makeFlag( TimeUnitRange.YEAR ), d ) );
            exMonthD = rexBuilder.makeCall( intAlgDataType, OperatorRegistry.get( OperatorName.EXTRACT ), ImmutableList.of( rexBuilder.makeFlag( TimeUnitRange.MONTH ), d ) );
            exDayD = rexBuilder.makeCall( intAlgDataType, OperatorRegistry.get( OperatorName.EXTRACT ), ImmutableList.of( rexBuilder.makeFlag( TimeUnitRange.DAY ), d ) );

            floorYear = rexBuilder.makeCall( intAlgDataType, OperatorRegistry.get( OperatorName.FLOOR ), ImmutableList.of( ts, rexBuilder.makeFlag( TimeUnitRange.YEAR ) ) );
            floorMonth = rexBuilder.makeCall( intAlgDataType, OperatorRegistry.get( OperatorName.FLOOR ), ImmutableList.of( ts, rexBuilder.makeFlag( TimeUnitRange.MONTH ) ) );
            floorDay = rexBuilder.makeCall( intAlgDataType, OperatorRegistry.get( OperatorName.FLOOR ), ImmutableList.of( ts, rexBuilder.makeFlag( TimeUnitRange.DAY ) ) );
            floorHour = rexBuilder.makeCall( intAlgDataType, OperatorRegistry.get( OperatorName.FLOOR ), ImmutableList.of( ts, rexBuilder.makeFlag( TimeUnitRange.HOUR ) ) );
            floorMinute = rexBuilder.makeCall( intAlgDataType, OperatorRegistry.get( OperatorName.FLOOR ), ImmutableList.of( ts, rexBuilder.makeFlag( TimeUnitRange.MINUTE ) ) );

            ceilYear = rexBuilder.makeCall( intAlgDataType, OperatorRegistry.get( OperatorName.CEIL ), ImmutableList.of( ts, rexBuilder.makeFlag( TimeUnitRange.YEAR ) ) );
            ceilMonth = rexBuilder.makeCall( intAlgDataType, OperatorRegistry.get( OperatorName.CEIL ), ImmutableList.of( ts, rexBuilder.makeFlag( TimeUnitRange.MONTH ) ) );
            ceilDay = rexBuilder.makeCall( intAlgDataType, OperatorRegistry.get( OperatorName.CEIL ), ImmutableList.of( ts, rexBuilder.makeFlag( TimeUnitRange.DAY ) ) );
            ceilHour = rexBuilder.makeCall( intAlgDataType, OperatorRegistry.get( OperatorName.CEIL ), ImmutableList.of( ts, rexBuilder.makeFlag( TimeUnitRange.HOUR ) ) );
            ceilMinute = rexBuilder.makeCall( intAlgDataType, OperatorRegistry.get( OperatorName.CEIL ), ImmutableList.of( ts, rexBuilder.makeFlag( TimeUnitRange.MINUTE ) ) );
        }
