...
public class MqlProcessorImpl implements MqlProcessor, ViewExpander {
    ...
    @Override
    public boolean needsDdlGeneration( Node mql, String database ) {
    ...
    @Override
    public void autoGenerateDDL( Statement statement, Node mql, String defaultDatabase ) {
        new MqlCreateCollection( ParserPos.sum( Collections.singletonList( mql ) ), ((MqlCollectionStatement) mql).getCollection(), null ).execute( statement.getPrepareContext(), statement, defaultDatabase );
        try {
    ...
    @Override
    public RelRoot translate( Statement statement, Node mql, String defaultDatabase ) {
        final StopWatch stopWatch = new StopWatch();
        if ( log.isDebugEnabled() ) {
    ...
    @Override
    public PolyphenyDbSignature<?> prepareDdl( Statement statement, Node parsed, String mql, String database ) {
