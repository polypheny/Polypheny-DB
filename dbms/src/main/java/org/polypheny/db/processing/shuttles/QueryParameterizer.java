...
public class QueryParameterizer extends AlgShuttleImpl implements RexVisitor<RexNode> {
    ...
    private final List<OperatorName> excluded = List.of( OperatorName.MQL_REGEX_MATCH, OperatorName.MQL_QUERY_VALUE, OperatorName.MQL_GEO_WITHIN, OperatorName.MQL_GEO_INTERSECTS, OperatorName.MQL_GEO_DISTANCE, OperatorName.MQL_NEAR, OperatorName.MQL_NEAR_SPHERE );
