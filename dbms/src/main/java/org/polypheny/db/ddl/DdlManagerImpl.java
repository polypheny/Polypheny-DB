...
//            result.getRowsChanged(statement);
    ...
    @Override
    public void createTrigger(long databaseId, long schemaId, String triggerName, boolean replace, String table, String event, String query, AlgNode algNode, QueryLanguage language) {
