...
public class RestTest {
    ...
    public void testOperations() {
        ...
        Assert.assertEquals(
                "{\"result\":[{\"test.resttest.tsmallint\":45,\"test.resttest.tdecimal\":123.45,\"test.resttest.ttinyint\":22,\"test.resttest.treal\":0.3333,\"test.resttest.tinteger\":9876,\"test.resttest.ttime\":\"43505000\",\"test.resttest.tbigint\":1234,\"test.resttest.tboolean\":true,\"test.resttest.tdate\":18466,\"test.resttest.tdouble\":1.999999,\"test.resttest.tvarchar\":\"hallo\",\"test.resttest.ttimestamp\":\"2020-07-23T12:05:05\"}],\"size\":1,\"query\":\"test.resttest.ttinyint\\u003d%3D22\",\"uri\":\"/restapi/v1/res/test.resttest\"}",
                executeRest( request ).getBody() );
