...
public class TemporalFunTest extends CypherTestTemplate {
    ...
    public void stringIntoDateFunTest() {
        ...
        assert containsRows( res, true, false, Row.of( TestLiteral.from( "2015-07-21" ) ) );

        res = execute( "RETURN date('2015-07')" );
        assert containsRows( res, true, false, Row.of( TestLiteral.from( "2015-07-01" ) ) );
        ...
        assert containsRows( res, true, false, Row.of( TestLiteral.from( "2015-01-01" ) ) );
    }
    ...
    public void yearMonthDayDateFunTest() {
        ...
        assert containsRows( res, true, false, Row.of( TestLiteral.from( "1984-01-01" ) ) );
    }
    ...
    public void yearWeekDayDateFunTest() {
        ...
        assert containsRows( res, true, false, Row.of( TestLiteral.from( "1984-03-07" ) ) );
    }
    ...
    public void yearQuarterDayDateFunTest() {
        ...
        assert containsRows( res, true, false, Row.of( TestLiteral.from( "1984-08-14" ) ) );
    }
    ...
    public void yearMonthDayZonedTimeDateFunTest() {
        ...
        assert containsRows( res, true, false, Row.of( TestLiteral.from( "1984-10-11T12:31:14.123456789Z" ) ) );

        res = execute( "datetime({year: 1984, month: 10, day: 11, hour: 12, minute: 31, second: 14, millisecond: 645, timezone: '+01:00'})" );
        assert containsRows( res, true, false, Row.of( TestLiteral.from( "1984-10-11T12:31:14.645+01:00" ) ) );

        res = execute( "RETURN datetime({year: 1984, month: 10, day: 11, hour: 12, minute: 31, second: 14})" );
        assert containsRows( res, true, false, Row.of( TestLiteral.from( "1984-10-11T12:31:14Z" ) ) );
    ...
    public void yearWeekDayTimeDateFunTest() {
        ...
        assert containsRows( res, true, false, Row.of( TestLiteral.from( "1984-03-07T12:31:14.645Z" ) ) );
    }
    ...
    public void yearQuarterDayTimeDateFunTest() {
        ...
        assert containsRows( res, true, false, Row.of( TestLiteral.from( "1984-08-14T12:31:14.645876Z" ) ) );
    ...
    public void stringIntoTimeDateFunTest() {
        ...
        assert containsRows( res, true, false, Row.of( TestLiteral.from( "2015-07-21T21:40:32.142+01:00" ) ) );
        res = execute( "RETURN datetime('2015-W30-2T214032.142Z')" );

        assert containsRows( res, true, false, Row.of( TestLiteral.from( "2015-07-21T21:40:32.142Z" ) ) );

        res = execute( "RETURN datetime('2015T214032-0100')" );

        assert containsRows( res, true, false, Row.of( TestLiteral.from( "2015-01-01T21:40:32-01:00" ) ) );

        res = execute( "RETURN datetime('20150721T21:40-01:30')" );

        assert containsRows( res, true, false, Row.of( TestLiteral.from( "2015-07-21T21:40-01:30" ) ) );

        res = execute( "RETURN datetime('2015-07-21T21:40:32.142[Europe/London]')" );

        assert containsRows( res, true, false, Row.of( TestLiteral.from( "datetime('2015-07-21T21:40:32.142[Europe/London]')" ) ) );
    ...
    public void timeFunTest() {
        ...
        assert containsRows( res, true, false, Row.of( TestLiteral.from( "12:31:14.123456789Z" ) ) );

        res = execute( "RETURN time({hour: 12, minute: 31, second: 14, nanosecond: 645876123})" );
        assert containsRows( res, true, false, Row.of( TestLiteral.from( "12:31:14.645876123Z" ) ) );

        res = execute( "RETURN time({hour: 12, minute: 31, second: 14, microsecond: 645876, timezone: '+01:00'})" );
        assert containsRows( res, true, false, Row.of( TestLiteral.from( "12:31:14.645876000+01:00" ) ) );

        res = execute( "time({hour: 12, minute: 31, timezone: '+01:00'})" );
        assert containsRows( res, true, false, Row.of( TestLiteral.from( "12:31:00+01:00" ) ) );

        res = execute( "RETURN time({hour: 12, timezone: '+01:00'})" );
        assert containsRows( res, true, false, Row.of( TestLiteral.from( "12:00:00+01:00" ) ) );
    ...
    public void stringIntoTimeFunTest() {
        ...
        assert containsRows( res, true, false, Row.of( TestLiteral.from( "21:40:32.142000000+01:00" ) ) );

        res = execute( "RETURN time('214032.142Z')" );
        assert containsRows( res, true, false, Row.of( TestLiteral.from( "21:40:32.142000000Z" ) ) );

        res = execute( "RETURN time('21:40:32+01:00')" );
        assert containsRows( res, true, false, Row.of( TestLiteral.from( "21:40:32+01:00" ) ) );
    ...
    public void durationFunTest() {
        ...
        assert containsRows( res, true, false, Row.of( TestLiteral.from( "P14DT16H12M" ) ) );

        res = execute( "RETURN duration({months: 5, days: 1.5})" );
        assert containsRows( res, true, false, Row.of( TestLiteral.from( "P5M1DT12H" ) ) );

        res = execute( "RETURN duration({months: 0.75})" );
        assert containsRows( res, true, false, Row.of( TestLiteral.from( "P22DT19H51M49.5S" ) ) );

        res = execute( "RETURN duration({weeks: 2.5})" );
        assert containsRows( res, true, false, Row.of( TestLiteral.from( "P17DT12H" ) ) );

        res = execute( "RETURN duration({minutes: 1.5, seconds: 1, milliseconds: 123, microseconds: 456, nanoseconds: 789})" );
        assert containsRows( res, true, false, Row.of( TestLiteral.from( "PT1M31.123456789S" ) ) );
    ...
    public void stringIntoDurationFunTest() {
        ...
        assert containsRows( res, true, false, Row.of( TestLiteral.from( "PT45S" ) ) );

        res = execute( "RETURN duration(\"P2012-02-02T14:37:21.545\")" );
        assert containsRows( res, true, false, Row.of( TestLiteral.from( "P2012Y2M2DT14H37M21.545S" ) ) );
