...
public class BasicMaterializedViewTest {
    ...
    @Test
    // we have to add these additional commits as this can lead to deadlocks atm, due to the locking approach employed struggling with really slow stores(e.g. neo4j)
