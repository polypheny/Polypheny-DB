...
public class ExcelEnumerator{
//public class ExcelEnumerator implements Enumerator<E>{
//    private final Iterator<Row> reader;
...
//
//
//        protected Object convert( ExcelFieldType fieldType, String string ) {
//            if ( fieldType == null ) {
//                return string;
//            }
//            switch ( fieldType ) {
